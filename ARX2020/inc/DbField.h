...
// this should not be ported anymore. But for binary compatibility, we still need to port it now.
#if ACADV_RELMAJOR > 23
#error  getHyperlink(ACHAR**,ACHAR**,ACHAR**,ACHAR**,int) should not be ported anymore. Please remove the ACDBCORE2D_PORT below when we can change.
#else
    ACDBCORE2D_PORT
#endif
