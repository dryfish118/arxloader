...
#define ACDB_OPEN_BRACE_CHAR           __OD_T('{')
#define ACDB_CLOSE_BRACE_STR           OD_T("}")
#define ACDB_CLOSE_BRACE_CHAR          __OD_T('}')
...
#define ACDB_SECTIONSTYLE_DICTIONARY   OD_T("ACAD_SECTIONVIEWSTYLE")
#define ACDB_DETAILSTYLE_DICTIONARY    OD_T("ACAD_DETAILVIEWSTYLE")
#pragma pack(push, 8)
