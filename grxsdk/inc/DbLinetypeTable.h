...
public:
  ...
  */
  virtual OdDbObjectId getAt( const OdChar*  recordName, 
                              bool getErasedRecord = false) const;
  OdDbSymbolTableRecordPtr getAt( const OdChar* recordName,
  ...
  */
  bool has( const OdChar *recordName ) const;
  ...
  */
  ...
  OdResult add(OdDbObjectId& recordId, OdDbLinetypeTableRecord* pRecord);

  OdResult add(OdDbLinetypeTableRecord* pRecord);
  ...
  */
  ...
  virtual OdResult dxfOut(OdDbDxfFiler* pFiler, OdBool allXdFlag = kTrue, unsigned char* regAppTable = NULL) const;
