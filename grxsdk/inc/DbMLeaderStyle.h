...
//  virtual ~OdDbMLeaderStyle();
  ...
  */
  virtual OdResult setBitFlags(OdUInt32 flags);
  ...
  */
  OdResult setContentType(ContentType contentType);
  ...
  */
  OdResult setDrawMLeaderOrderType(DrawMLeaderOrderType drawMLeaderOrderType);
  ...
  */
  OdResult setDrawLeaderOrderType(DrawLeaderOrderType drawLeaderOrderType);
  ...
  */
  OdResult setMaxLeaderSegmentsPoints(int maxLeaderSegmentsPoints);
  ...
  */
  OdResult setFirstSegmentAngleConstraint(SegmentAngleType angle);
  ...
  */
  ...
  /** \details
    ...
    A value of kAny for "angle" indicates that no constraint is used.
  */
  OdResult setSecondSegmentAngleConstraint(SegmentAngleType angle);
  ...
  */
  OdResult setLeaderLineType(LeaderType leaderLineType);
  ...
  */
  OdResult setLeaderLineColor(const OdCmColor& leaderLineColor);
  ...
  */
  OdResult setLeaderLineWeight(OdDb::LineWeight leaderLineWeight);
  ...
  */
  OdResult setEnableLanding(bool enableLanding);
  ...
  */
  OdResult setEnableDogleg(bool enableDogleg);
  ...
  */
  OdResult setArrowSymbolId(const OdString& name);
  ...
  */
  OdResult setArrowSize(double arrowSize);
  ...
  */
  OdResult setTextStyleId(OdDbObjectId textStyleId);
  ...
  */
  ...
  OdResult setTextAttachmentType(TextAttachmentType textAttachmentType);
  ...
  */
  OdResult setTextAngleType(TextAngleType textAngleType);
  ...
  */
  OdResult setTextAlignmentType(TextAlignmentType textAlignmentType);
  ...
  */
  OdResult setTextHeight(double textHeight);
  ...
  */
  OdResult setAlignSpace(double alignSpace);
  ...
  */
  OdResult setBlockId(const OdString& name);
  ...
  */
  OdResult setBlockId(OdDbObjectId blockId);
  ...
  */
  OdResult setBlockColor(const OdCmColor& blockColor);
  ...
  */
  OdResult setBlockScale(const OdGeScale3d& scale);
  ...
  */
  OdResult setEnableBlockScale(bool enableBlockScale);
  ...
  */
  OdResult setBlockRotation(double rotation);
  ...
  */
  OdResult setEnableBlockRotation(bool enableBlockRotation);
  ...
  */
  OdResult setBlockConnectionType(BlockConnectionType blockConnectionType);
  ...
  */
  OdResult setAnnotative(bool isAnnotative);
  ...
  */
  OdResult setBreakSize(double size);
  ...
  */
  OdResult setExtendLeaderToText(bool bSet);
