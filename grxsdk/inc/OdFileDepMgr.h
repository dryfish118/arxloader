...
class OdFileDependencyIteratorMtSafe
{
public:
  OdFileDependencyIteratorMtSafe(OdFileDependencyManager* pManager)
    : m_pManager(pManager)
  {
  }

  ~OdFileDependencyIteratorMtSafe()
  {
    m_pManager->iteratorUnInitialize();
  }
private:
  OdFileDependencyManager *m_pManager;
};
