...
public:
  ...
  */
  const OdChar* identifierExcludeCharacters() const;
  ...
  */
  OdResult setIdentifierExcludeCharacters(const OdChar* str);
  ...
  */
  const OdChar* viewLabelPattern() const;


  OdResult getViewLabelPattern(OdString &pattern,
    OdDbField *pField = NULL) const;
  /** \details
    Returns the view label's pattern.
  ...
  */
  const OdChar* hatchPattern() const;

  /** \details
    Sets the hatch pattern.
  */
  OdResult setHatchPattern(const OdChar* pattern);
  ...
  */
  ...
  //*/
  static bool validateIdentifierExcludeCharacters(const OdChar* str);
