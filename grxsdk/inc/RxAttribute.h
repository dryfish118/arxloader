...
protected:
  ...
  OdRxLocalizedNameAttribute(unsigned int id);
  OdRxLocalizedNameAttribute(unsigned int id, unsigned int sourceHint);
  //DOM-IGNORE-END
};
...
public:
  ...
  */
  ...
  //DOM-IGNORE-END
  OdRxAlternateLocalizedNameAttribute(unsigned int id);
  OdRxAlternateLocalizedNameAttribute(unsigned int id, unsigned int sourceHint);
};
...
public:
  ...
  OdRxUiPlacementAttribute(const OdChar* category, unsigned int weight);
  //DOM-IGNORE-END
...
public:
  ...
  //DOM-IGNORE-END
  OdRxDescriptionAttribute(const OdChar* desc);
  OdRxDescriptionAttribute(unsigned int id);
  OdRxDescriptionAttribute(unsigned int id, unsigned int sourceHint);
...
protected:
  ...
  //DOM-IGNORE-END
  OdRxRefersToAttribute(const OdChar* path);
};
...
protected:
  ...
  //DOM-IGNORE-END
  OdRxCOMAttribute(const OdChar* name);
};
...
protected:
  ...
  //DOM-IGNORE-END
  OdRxUnitTypeAttribute(UnitType unitType);
};

class FIRSTDLL_EXPORT OdRxGenerateDynamicPropertiesAttribute : public OdRxAttribute
{
public:
...
public:
  OdRxUseDialogForReferredCollectionAttribute();
};
...
protected:
  ...
  OdRxUiCascadingContextMenuAttribute();
};
//DOM-IGNORE-END
...
public:
  ...
  */
  ...
  OdRxCumulativeAttribute(const OdChar* type);
protected:
  //DOM-IGNORE-BEGIN
...
public:
  ...
  */
  ...
  OdRxAffinityAttribute(const OdChar* name);
protected:
  //DOM-IGNORE-BEGIN
...
public:
  ...
  */
  ...
  OdRxTypePromotionAttribute(const OdChar* properties);
protected:
  //DOM-IGNORE-BEGIN
...
public:
  ...
  */
  ...
  OdRxDefaultValueAttribute(const OdRxValue& value);
protected:
  //DOM-IGNORE-BEGIN
...
//DOM-IGNORE-END
  ...
  */
  ...
  static OdString getDisplayValue(const OdRxDisplayAsAttribute* pAttr, const OdDbObjectId& id);

  const OdChar* path() const;
  //DOM-IGNORE-BEGIN
  OdRxDisplayAsAttribute(OdRxDisplayAsAttributeImpl* pImpl);
  OdRxDisplayAsAttribute();
  //DOM-IGNORE-END
  OdRxDisplayAsAttribute(const OdChar* name);
};
...
public:
  ...
  */
  ...
  /** \details
    Retrieve the attribute by its name (non-constant version).
