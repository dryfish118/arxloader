...
public:
  ...
  /** \details
    ...
    See: <link db_layer_add_name, Adding and Naming Layers>
  */
  ...
  */
  OdResult setIsFrozen(bool bStatus);
  ...
  */
  ...
  enum { kDxfLayerPlotBit = OdDb::kDxfBool };
  ...
  */
  OdResult setIsPlottable(bool bStatus);
  ...
  */
  OdResult setIsHidden( bool bStatus );
  ...
  */
  OdResult setIsReconciled( bool bStatus = true );
  ...
  */
  ...
  /** \details
    ...
    OdDbLayerTableRecord::setTransparency() method
  */
  OdCmTransparency transparency( const OdDbObjectId& idViewport, bool& IsOverride) const;
  ...
  */
  ...
  /** \details
    ...
    OdDbLayerTableRecord::transparency() method
  */
  OdResult setTransparency(const OdCmTransparency& cmTransparency, const OdDbObjectId& idViewport);
  ...
  */
  ...
  /** \details
    ...
    OdDbLayerTableRecord::color() method
  */
  OdResult setColor( const OdCmColor& cmColor, const OdDbObjectId& idViewport );
  ...
  */
  OdResult setLineWeight(OdDb::LineWeight kLnWtEnum);
  ...
  /** \details
    ...
    OdDbLayerTableRecord::lineWeight() method
  */
  OdResult setLineWeight(OdDb::LineWeight kLnWtEnum, const OdDbObjectId& idViewport);
  ...
  */
  OdResult setLinetypeObjectId( OdDbObjectId idLinetype );
  ...
  /** \details
    ...
    OdDbLayerTableRecord::linetypeObjectId() method
  */
  OdResult setLinetypeObjectId( const OdDbObjectId& idLinetype, const OdDbObjectId& idViewport );
  ...
  */
  OdResult setMaterialId( OdDbObjectId idMaterial );
  ...
  */
  ...
  /** \details
    ...
    <link !!OVERLOADED_plotStyleName_OdDbLayerTableRecord, OdDbLayerTableRecord::plotStyleName()>, <link !!OVERLOADED_plotStyleNameId_OdDbLayerTableRecord, OdDbLayerTableRecord::plotStyleNameId()> methods
  */
  OdResult setPlotStyleName( const OdChar* sPlotStyleName, const OdDbObjectId& idViewport);
  ...
  /** \details
    ...
    <link !!OVERLOADED_plotStyleName_OdDbLayerTableRecord, OdDbLayerTableRecord::plotStyleName()>, <link !!OVERLOADED_plotStyleNameId_OdDbLayerTableRecord, OdDbLayerTableRecord::plotStyleNameId()> methods
  */
  OdResult setPlotStyleName( OdDbObjectId idPlotStyle );
  ...
  /** \details
    ...
    <link !!OVERLOADED_plotStyleName_OdDbLayerTableRecord, OdDbLayerTableRecord::plotStyleName()>, <link !!OVERLOADED_plotStyleNameId_OdDbLayerTableRecord, OdDbLayerTableRecord::plotStyleNameId()> methods
  */
  OdResult setPlotStyleName( const OdDbObjectId& idPlotStyle, const OdDbObjectId& idViewport);
  ...
  */
  OdString description(ODSYSDEF) const;
  OdChar*  description() const;
  ...
  */
  ...
  OdResult removeColorOverride(const OdDbObjectId& idViewport);

  OdResult removeLinetypeOverride(const OdDbObjectId& idViewport);

  OdResult removeLineWeightOverride(const OdDbObjectId& idViewport);

  OdResult removePlotStyleOverride(const OdDbObjectId& idViewport);

  OdResult removeTransparencyOverride( const OdDbObjectId& idViewport );

  OdResult removeViewportOverrides(const OdDbObjectId& idViewport);
