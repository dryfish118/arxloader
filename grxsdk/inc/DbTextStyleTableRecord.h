...
/** \details
  ...
  \sa
  <link db_textstyle_sample_table, Example of Working with the Text Style Table Object>

  <link db_textstyle_sample_record, Example of Working with the Text Style Record Object>

  \sa
  <link db_textstyle, Working with Text Styles>
...
public:
  ...
  /** \details
    ...
    See: <link db_textstyle_add_name, Adding and Naming Text Styles>
  */
  ...
  /** \details
    ...
    \sa
    <link db_textstyle_font, Fonts of Text Styles>
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link db_textstyle_properties, Specific Properties of Text Styles>
  ...
  */
  OdResult setTextSize(double vSize);
  ...
  */
  OdResult setXScale(double xFactor);


  /** \details
    Returns the obliquing angle in range ?.48335 radians (?5? (DXF 50). This angle influences on
  ...
  */
  ...
  /** \details
    Sets the obliquing angle of letters in range ?.48335 radians (?5? (DXF 50). A positive angle 
    ...
    \param vAngle [in]  Obliquing angle in radians as a Double value in range ?.48335.
  ...
  */
  OdResult setObliquingAngle(double vAngle);
  ...
  */
  OdResult setPriorSize(double vSize);
  ...
  */
  ...
  OdResult fileName(OdChar*& pName) const;
  OdResult fileName(const OdChar*& pName) const;
  ...
  */
  OdResult setFileName(const OdChar * filename);
  ...
  */
  ...
  OdResult bigFontFileName(OdChar*& pName) const;
  OdResult bigFontFileName(const OdChar*& pName) const;
  ...
  */
  OdResult setBigFontFileName(const OdString& sBigFont);
  ...
  */
  OdResult setFont(const OdString& typeface, bool bold, bool italic, int charset, int pitchAndFamily);

  OdResult setFont(const OdChar* pTypeface, OdBool bold,
    OdBool italic, Charset charset,
    Gstarsoft::GstarCAD::PAL::FontUtils::FontPitch pitch,
  ...
  virtual OdResult subHandOverTo( OdDbObject* pNewObject );
