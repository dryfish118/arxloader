...
typedef std::map<OdDbEntity*, OdUInt32> OdDbSectionGeometryMap;
...
public:
  ...
  */
  OdDbSection();
  OdDbSection(const OdGePoint3dArray& pts, const OdGeVector3d& verticalDir);
  OdDbSection(const OdGePoint3dArray& pts, const OdGeVector3d& verticalDir, const OdGeVector3d& vecViewingDir);
 ~OdDbSection(void);
  /** \details
  ...
  */
  OdResult setName(const OdString& pszName);
...
public:
 ...
 OdResult generateSectionGeometry(const OdDbVoidPtrArray& bodies,
                                  const OdDbIntArray& instanceCount,
                                  const OdArray<OdGeMatrix3d>& xforms,
                                  const OdArray<OdRxClass*>& providerClasses,
                                  OdArray<OdDbEntity*>& intBoundaryEnts,
                                  OdArray<OdDbEntity*>& intFillEnts,
                                  OdArray<OdDbEntity*>& backgroundEnts,
                                  OdArray<OdDbEntity*>& foregroundEnts,
                                  OdArray<OdDbEntity*>& curveTangencyEnts,
                                  OdDbSectionGeometryMap* = NULL) const;
  //DOM-IGNORE-END
