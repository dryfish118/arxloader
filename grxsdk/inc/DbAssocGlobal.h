...
class OdDbAssocPersSubentManagerCloner;
class OdDbAssocNotificationData;
...
class LUMP;
class BODY;
typedef OdArray<BODY*>            OdDbAsmBodyArray;
typedef OdArray<ENTITY*>          OdDbAsmEntityArray;
typedef OdArray<EDGE*>            OdDbAsmEdgeArray;
typedef OdArray<FACE*>            OdDbAsmFaceArray;
typedef OdArray<OdDbAsmEdgeArray> OdDbAsmEdgeArray2d;
...
#   endif
    ...
    */
    ...
    virtual void allDependentActionsMarkedToEvaluate(OdDbAssocNetwork* /*pNetwork*/) 
    {
    }
...
public:
  ...
  */
  virtual void dependencyNeedsToEvaluate(OdDbAssocDependency* dependency, OdDbAssocStatus newStatus) {}
...
DBCONSTRAINTS_EXPORT OdResult checkTopLevelNetworkIntegrity(const OdDbDatabase*);
...
{
    /*!DOM*/
    kOdDbAssocCreateImpObject = 0,
    /*!DOM*/
    kOdDbAssocDoNotCreateImpObject = 1,
};

typedef unsigned                       OdDbPersElemId;
typedef OdDbPersElemId                 OdDbPersStepId;
typedef OdDbPersElemId                 OdDbPersSubentId;
typedef OdArray<OdDbPersElemId>        OdDbPersElemIdArray;
typedef OdArray<OdDbPersStepId>        OdDbPersStepIdArray;
typedef OdArray<OdDbPersSubentId>      OdDbPersSubentIdArray;
typedef OdArray<OdDbPersElemIdArray>   OdDbPersElemIdArray2d;

const OdDbPersElemId kOdDbPersNullId = 0;
