...
public:
  ...
  */
  ...
  virtual OdResult cancel(OdDbObject* pSubject);
  ...
  */
  ...
  virtual OdResult deepClone(const OdDbObject* pSubject, OdDbObject* pOwnerObject, OdDbObject*& pClonedObject, OdDbIdMapping& idMap, OdBool isPrimary = true);

  virtual OdResult wblockClone(const OdDbObject* pSubject, OdRxObject* pOwnerObject, OdDbObject*& pClonedObject, OdDbIdMapping& idMap, OdBool isPrimary = true);
};
...
public:
  ...
  */
  virtual OdResult getClassID(const OdDbObject* pSubject, CLSID* pClsid);
