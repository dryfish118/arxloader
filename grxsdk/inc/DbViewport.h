...
public:
  ...
  */
  OdResult setOff();
  DBENT_EXPORT OdResult setIsOn(bool bOn);
  ...
  */
  ...
  DBENT_EXPORT OdResult setFrontClipOn(bool bOn);
  ...
  */
  ...
  DBENT_EXPORT OdResult setBackClipOn(bool bOn);
  /** \details
  ...
  */
  ...
  DBENT_EXPORT OdResult setFrontClipAtEyeOn(bool bOn);
  ...
  */
  ...
  DBENT_EXPORT OdResult setPerspectiveOn(bool bOn);
  ...
  */
  ...
  DBENT_EXPORT OdResult setUcsFollowModeOn(bool bOn);
  ...
  */
  ...
  DBENT_EXPORT OdResult setUcsIconVisible(bool);
  ...
  */
  ...
  DBENT_EXPORT OdResult setUcsIconAtOrigin(bool);
  ...
  */
  ...
  DBENT_EXPORT OdResult setFastZoomOn(bool);
  ...
  */
  OdResult setSnapOn();
  DBENT_EXPORT OdResult setSnapOn(bool);
  ...
  */
  ...
  DBENT_EXPORT OdResult setSnapIsometric(bool);
  ...
  */
  OdResult setSnapIncrement(const OdGeVector2d& snapIncrement);
  ...
  */
  OdResult setGridOn();
  DBENT_EXPORT OdResult setGridOn(bool);
  ...
  */
  ...
  DBENT_EXPORT OdResult removeHiddenLines(bool);
  /** \details
  ...
  */
  OdResult setLocked();
  DBENT_EXPORT OdResult setLocked(bool);
  ...
  */
  ...
  DBENT_EXPORT OdResult setTransparent(bool);
  ...
  */
  ...
  DBENT_EXPORT OdResult setNonRectClipOn(bool bOn);
  /** \details
  ...
  */
  OdResult setModelView(const OdDbXrefObjectId &objId);
  ...
  */
  OdResult setSheetView(const OdDbObjectId &objId);
  ...
  */
  OdResult setLabelBlock(const OdDbObjectId objId);
