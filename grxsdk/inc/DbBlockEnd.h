...
/** \details
    ...
    \remarks
  OdDbBlockEnd entities are created and handled automatically for each
  OdDbBlockTableRecord object.
...
public:
  ...
  /** \details
    This is the default constructor for objects of the OdDbBlockEnd class.
  */
  OdDbBlockEnd();
