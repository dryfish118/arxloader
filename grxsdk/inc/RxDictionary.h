...
public:
  ...
  */
  ...
  void removeAll() { OdUInt32 n = numEntries();  while(n--) ODSYSCALL1(remove,n); }
  ...
  */
  ...
  virtual OdRxDictionaryIterator* newIterator(OdRx::DictIterType iterType = OdRx::kDictSorted) = 0;
  ...
  */
  ...
  virtual OdBool isSorted() const = 0;
