...
/** \details
  ...
  \sa
  <link db_solid2d_sample, Example of Working with the Planar Solid Object>

  \sa
  <link db_solid2d, Working with Planar Solids>
...
public:
  ...
  /** \details
    ...
    See: <link db_solid2d_overview, Overview of Planar Solids>
  */
  OdDbSolid();
  ...
  /** \details
    ...
    \sa
    <link db_solid2d_specific, Specific Planar Solid Properties>

    OdDbSolid::setPointAt() method
  */
  OdResult getPointAt( int pointIndex, OdGePoint3d& pointValue ) const;
  ...
  */
  OdResult setPointAt( int pointIndex, const OdGePoint3d& pointValue );
