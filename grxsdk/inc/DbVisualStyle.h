...
public:
  ...
  */
  OdResult setDescription(const OdChar* pDescription);
  ...
  */
  ...
  /** \details
      ...
      \param op [in]  OdGiVisualStyleOperations::Operation to use for setting the property. 
  */
  OdResult setTrait(OdGiVisualStyleProperties::Property prop, int nVal,
                OdGiVisualStyleOperations::Operation op = OdGiVisualStyleOperations::kSet);
  ...
  */
  const OdGiVariant& trait(OdGiVisualStyleProperties::Property prop, OdGiVisualStyleOperations::Operation *pOp = NULL) const;
  ...
  */
  OdResult name(OdString &value) const;
