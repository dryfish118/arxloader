...
public:
  ...
  */
  ...
  TOOLKIT_EXPORT OdResult   setUsingDefaultTextPosition(bool);
  ...
  */
  ...
  virtual void        erased(OdDbObject* dbObj, OdBool bErasing);
  /** \details
...
#undef  VAR_DEF
  ...
  OdResult   setHorizontalRefTextRotation(bool newVal);
  ...
  */
  OdResult setDynamicDimension(
    bool bDynamic);

  //new getOsnapPoints API
  OdResult getOsnapPointsAtSubentPath(OdDb::OsnapMode osnapMode,
                                      const OdDbFullSubentPath& subentId,
  ...
  */
  ...
  TOOLKIT_EXPORT double       centerMarkSize() const;
  TOOLKIT_EXPORT OdResult     prefix(OdString& sPrefix) const;
  TOOLKIT_EXPORT OdResult     setPrefix(const OdString&);
  TOOLKIT_EXPORT OdResult     suffix(OdString&) const;
  TOOLKIT_EXPORT OdResult     setSuffix(const OdString&);

  TOOLKIT_EXPORT OdResult     alternateSuffix(OdString&) const;
  TOOLKIT_EXPORT OdResult     setAlternateSuffix(const OdString&);
  TOOLKIT_EXPORT OdResult     alternatePrefix(OdString&) const;
  TOOLKIT_EXPORT OdResult     setAlternatePrefix(const OdString&);

  TOOLKIT_EXPORT bool         suppressAngularLeadingZeros() const;
  TOOLKIT_EXPORT OdResult     setSuppressAngularLeadingZeros(bool);

  TOOLKIT_EXPORT bool         suppressAngularTrailingZeros() const;
  TOOLKIT_EXPORT OdResult     setSuppressAngularTrailingZeros(bool);

  TOOLKIT_EXPORT bool         altSuppressZeroInches() const;
  TOOLKIT_EXPORT OdResult     setAltSuppressZeroInches(bool);
  TOOLKIT_EXPORT bool         altSuppressZeroFeet() const;
  TOOLKIT_EXPORT OdResult     setAltSuppressZeroFeet(bool);
  TOOLKIT_EXPORT bool         altSuppressTrailingZeros() const;
  TOOLKIT_EXPORT OdResult     setAltSuppressTrailingZeros(bool);

  TOOLKIT_EXPORT bool         altToleranceSuppressLeadingZeros() const;
  TOOLKIT_EXPORT OdResult     setAltToleranceSuppressLeadingZeros(bool);
  TOOLKIT_EXPORT bool         altToleranceSuppressZeroInches() const;
  TOOLKIT_EXPORT OdResult     setAltToleranceSuppressZeroInches(bool);

  TOOLKIT_EXPORT bool         altToleranceSuppressZeroFeet() const;
  TOOLKIT_EXPORT OdResult     setAltToleranceSuppressZeroFeet(bool);
  TOOLKIT_EXPORT bool         altToleranceSuppressTrailingZeros() const;
  TOOLKIT_EXPORT OdResult     setAltToleranceSuppressTrailingZeros(bool);

  TOOLKIT_EXPORT bool         suppressZeroFeet() const;
  TOOLKIT_EXPORT OdResult     setSuppressZeroFeet(bool);
  TOOLKIT_EXPORT bool         suppressTrailingZeros() const;
  TOOLKIT_EXPORT OdResult     setSuppressTrailingZeros(bool);
  TOOLKIT_EXPORT bool         suppressLeadingZeros() const;
  TOOLKIT_EXPORT OdResult     setSuppressLeadingZeros(bool);
  TOOLKIT_EXPORT bool         suppressZeroInches() const;
  TOOLKIT_EXPORT OdResult     setSuppressZeroInches(bool);

  TOOLKIT_EXPORT bool         altSuppressLeadingZeros() const;
  TOOLKIT_EXPORT OdResult     setAltSuppressLeadingZeros(bool);
  TOOLKIT_EXPORT bool         toleranceSuppressZeroFeet() const;
  TOOLKIT_EXPORT OdResult     setToleranceSuppressZeroFeet(bool);

  TOOLKIT_EXPORT bool         toleranceSuppressTrailingZeros() const;
  TOOLKIT_EXPORT OdResult     setToleranceSuppressTrailingZeros(bool);
  TOOLKIT_EXPORT bool         toleranceSuppressLeadingZeros() const;
  TOOLKIT_EXPORT OdResult     setToleranceSuppressLeadingZeros(bool);

  TOOLKIT_EXPORT bool         toleranceSuppressZeroInches() const;
  TOOLKIT_EXPORT OdResult     setToleranceSuppressZeroInches(bool);
  enum CenterMarkType {
    kMark = 0,
    kLine = 1,
    kNone = 2
  ...
  TOOLKIT_EXPORT OdDbDimension::CenterMarkType centerMarkType() const;
  ...
  */
  ...
  OdResult   fieldToMText(OdDbMText* pDimMText);
  OdResult   fieldFromMText(OdDbMText* pDimMText);
  /** \details
  ...
  */
  void textDefinedSize(
    ...
    double& height) const;
protected:
  OdDbObjectId   subDimensionStyle() const;
  OdResult   subSetDimensionStyle(OdDbObjectId dimStyleId);
  OdResult   subGetDimstyleData(OdDbDimStyleTableRecord*& pRecord) const;
  OdResult   subSetDimstyleData(OdDbDimStyleTableRecord* pNewData);
  OdResult   subSetDimstyleData(OdDbObjectId newDataId);
};
