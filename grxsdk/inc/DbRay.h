...
/** \details
  ...
  \sa
  <link db_ray_sample, Example of Working with the Ray Object>

  \sa
  <link db_ray, Working with Rays>
...
public:
  ...
  /** \details
    ...
    See: <link db_ray_overview, Overview of Rays>
  */
  OdDbRay();
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link db_ray_specific, Specific Ray Properties>
  ...
  */
  ...
  OdGePoint3d secondPoint() const;
  OdResult setSecondPoint(OdGePoint3d const & pt);
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link db_ray_compute, Computed Ray Properties>
  */
