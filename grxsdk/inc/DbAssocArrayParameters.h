...
public:
  ...
  */
  virtual OdResult getItems(OdArray<OdDbAssocArrayItem*>& items) const = 0;
  ...
  */
  virtual OdResult getGripPointAt(unsigned int mode, OdDbArrayGripAppData* &pGrip) const;
  ...
  */
  ...
  virtual OdResult getGripPoints(OdArray<OdDbArrayGripAppData*>& grips) const;

  /** \details
    Moves an array of grip points.
  */
  virtual OdResult moveGripPointAt(const OdDbArrayGripAppData* pGrip,
