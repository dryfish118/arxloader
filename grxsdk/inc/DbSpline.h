...
public:
  ...
  OdDbSpline(const OdGePoint3dArray& fitPoints,
    bool                    periodic,
    OdGe::KnotParameterization  knotParam = OdGe::kUniform,
    int                     degree = 3,
    double                  fitTolerance = 0.0);
  OdDbSpline(const OdGePoint3dArray& fitPoints,
  ...
  */
  OdResult insertFitPointAt(int fitPointIndex, const OdGePoint3d& point);
  ...
  /** \details
    ...
    \param fitPointIndex [in]  Fit point index.
  */
  OdResult removeFitPointAt(int fitPointIndex);
  ...
  */
  OdResult setFitTol(double fitTolerance);
  ...
  */
  OdResult setWeightAt(int weightIndex, double weight);
...
*/
  ...
  */
  OdResult modifyPositionAndTangent(double param, const OdGePoint3d& point, const OdGeVector3d* deriv);
