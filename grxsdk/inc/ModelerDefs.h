...
/** \details
  Enumeration for convAcisColors flag. Allows you to turn on conversion colors from acis rgb colors to adesk colors.
  It contains two bits, most right responds for conversion (when 1 - conversion enabled), second respond for
  replacing the existing (when 1 - created color will replace existing).

  <table>
  <b>Value</b>           <b>Description</b>
  kConvNone              colors keep untouched
  kConvAcisColors        conversion acis colors to adesk colors
  kConvAndReplaceColors  conversion acis colors to adesk colors with replacing existing adesk colors
  </table>
*/
