...
class OdDbHighlightStateOverrule : public OdRxOverrule
{
public:
  ODRX_DECLARE_MEMBERS(OdDbHighlightStateOverrule);
  TOOLKIT_EXPORT OdDbHighlightStateOverrule();
  TOOLKIT_EXPORT virtual OdResult  pushHighlight(
                                                  OdDbEntity*               pSubject,
                                                  const OdDbFullSubentPath& subId,
                                                  OdGiHighlightStyle        highlightStyle);
  TOOLKIT_EXPORT virtual OdResult  popHighlight(
                                                  OdDbEntity*               pSubject,
                                                  const OdDbFullSubentPath& subId);
  TOOLKIT_EXPORT virtual OdGiHighlightStyle highlightState(
                                                            OdDbEntity*               pSubject,
                                                            const OdDbFullSubentPath& subId);
};
