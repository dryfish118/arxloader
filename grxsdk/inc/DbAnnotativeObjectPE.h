...
public:
  ...
  */
    virtual bool annotative(OdDbObject* pObject) const = 0;
  ...
  */
   ...
   */
   ...
   /** \details
    Not implemented.
   */
    virtual bool decompose(OdDbObject* /*pObj*/, OdDb::SaveFileType /*format*/, OdDb::DwgVersion /*version*/) { return false; }
};
