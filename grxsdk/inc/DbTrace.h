...
/** \details
  ...
  \sa
  <link db_trace_sample, Example of Working with the Trace Object>

  \sa
  <link db_trace, Working with Traces>
...
public:
  ...
  /** \details
    ...
    See: <link db_trace_overview, Overview of Traces>
  */
  OdDbTrace();
  ...
  /** \details
    ...
    \sa
    <link db_trace_specific, Specific Trace Properties>
