...
/** \details
  ...
  <link db_linetype_sample_dash, Example of Working with the Linetype Dash>
...
public:
  ...
  /** \details
    ...
    See: <link db_linetype_add_name, Adding and Naming Linetypes>
  */
  ...
  /** \details
    ...
    \sa
    <link db_linetype_properties, Specific Properties of Linetypes>
...
*/
  ...
  */
  OdResult setPatternLength( double vLength );
  ...
  /** \details
    ...
    \sa
    <link db_linetype_pattern, Working with the Linetype Pattern>
  ...
  */
  OdResult setNumDashes( int numberDashes );
  ...
  */
  OdResult setDashLengthAt( int dashIndex, double dashLength );
  ...
  */
  OdResult setShapeStyleAt( int dashIndex, OdDbObjectId idTextStyle );
  ...
  */
  OdResult setShapeNumberAt( int dashIndex, OdUInt16 shapeNumber );
 ...
 */
  ...
  */
  OdResult setTextAt( int dashIndex, const OdString& textString );
  ...
  */
  OdResult setShapeOffsetAt( int dashIndex, const OdGeVector2d& shapeOffset );
  ...
  */
  OdResult setShapeScaleAt( int dashIndex, double shapeScale );
  ...
  */
  ...
  /** \details
    ...
    is greater than 2PI, it converts to the range ?PI. The initial value is zero by default.
  ...
  */
  OdResult setShapeRotationAt( int dashIndex, double shapeRotation );
  ...
  */
  OdResult setShapeIsUcsOrientedAt( int dashIndex, bool isUcsOriented );
  ...
  */
  OdResult setShapeIsUprightAt( int dashIndex, bool isUpright );
