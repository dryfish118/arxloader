...
/** \details
  ...
  \sa
  <link db_ellipse_sample, Example of Working with the Ellipse Object>
  \sa
  <link db_elliptical_arc_sample, Example of Working with the Elliptical Arc>
  \sa
  <link db_ellipse, Working with Ellipses>
...
public:
  ...
  /** \details
    ...
    See: <link db_ellipse_overview, Overview of Ellipses>
  */
  OdDbEllipse();
  ...
  /** \details
    ...
    <link db_elliptical_arc_sample, Example of Working with the Elliptical Arc>
    \sa
    <link db_ellipse_specific, Specific Ellipse Properties>
  ...
  */
  ...
  TOOLKIT_EXPORT double majorRadius() const;
  TOOLKIT_EXPORT OdResult setMajorRadius(double);
  TOOLKIT_EXPORT double minorRadius() const;
  TOOLKIT_EXPORT OdResult setMinorRadius(double);
  ...
  */
  OdResult setRadiusRatio( double radiusRatio );
  ...
  /** \details
    ...
    <link db_elliptical_arc_sample, Example of Working with the Elliptical Arc>
    \sa
    <link db_elliptical_arc_specific, Specific Elliptical Arc Properties>
    \sa
  ...
  */
  ...
  /** \details
    Sets the start angle for the elliptical figure (ellipse or arc) in the range ?PI  
  ...
  */
  ...
  /** \details
    Sets the end angle for the elliptical figure (ellipse or arc) in the range ?PI 
  ...
  */
  ...
  /** \details
    ...
    <link db_elliptical_arc_sample, Example of Working with the Elliptical Arc>
    \sa
    <link db_ellipse_compute, Computed Ellipse and Elliptical Arc Properties>
	\sa
    <link db_elliptical_arc_specific, Specific Elliptical Arc Properties>
    \sa
