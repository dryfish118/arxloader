...
public:
  ...
  */
  ...
  /** \details
    ...
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  virtual OdResult getCoordinateSystemAt(int index, OdDbGeoCoordinateSystem*& pCoordSys) const = 0;
  ...
  /** \details
    ...
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  static  OdResult createAll(OdArray<OdDbGeoCoordinateSystemCategory*>& allCategories);
};
...
public:
  ...
  */
  ...
  /** \details
    ...
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  virtual OdResult getCartesianExtents(OdDbExtents2d& exts) const = 0;
  /** \details
    ...
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  virtual OdResult getGeodeticExtents(OdDbExtents2d& exts) const = 0;
  /** \details
  ...
  */
  static OdResult create(const OdString& coordSysIdOrFullDef, 
    OdDbGeoCoordinateSystem*& pCoordSys);
  /** \details
    ...
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  static OdResult createAll(const OdGePoint3d& geoPt, OdArray<OdDbGeoCoordinateSystem*>& allCoordSys);
  /** \details
    Creates and returns a new OdDbGeoCoordinateSystem object for every existing, 
  ...
  */
  static OdResult createAll(OdArray<OdDbGeoCoordinateSystem*>& allCoordSys,
...
public:
  ...
  */
  static OdResult create(const OdString& sourceCoordSysId, 
    const OdString& targetCoordSysId,
    OdDbGeoCoordinateSystemTransformer*& pCoordSysTransformer);
};
