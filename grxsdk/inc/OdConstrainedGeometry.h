...
public:
  ...
  */
  ...
  OdConstrainedPoint(OdDbObjectId geomDependencyId);
...
public:
  ...
  */  
  ...
  /** \details
    Constructor creates an instance of this class.
  */
  OdConstrainedImplicitPoint(bool bCreateImp = true);

  OdConstrainedImplicitPoint(OdGraphNode::Id constrCurvId, OdDb::ImplicitPointType ptype, int index = -1);
  /** \details
    Initializes this implicit point node.
  */
  OdResult init(OdConstraintGroupNodeId constrCurvId, OdDb::ImplicitPointType ptype, int index = -1);

  /** \details
    Returns the implicit point type.
  */
  OdDb::ImplicitPointType pointType() const;
...
public:
  ...
  */
  ...
  OdConstrainedLine(OdDbObjectId geomDependencyId);
...
public:
  ...
  /** \details
    Constructor creates an instance of this class.
  */
  OdConstrained2PointsConstructionLine(bool bCreateImp = true);

  OdConstrained2PointsConstructionLine(const OdGePoint3d& point1, const OdGePoint3d& point2);
...
public:
  ...
  /** \details
    Constructor creates an instance of this class.
  */
  OdConstrainedDatumLine(bool bCreateImp = true);

  OdConstrainedDatumLine(const OdGePoint3d& pointOnLine, const OdGeVector3d& direction);
...
public:
  ...
  /** \details
    Constructor creates an instance of this class.
  */
  OdConstrainedBoundedLine(bool bCreateImp = true);


  OdConstrainedBoundedLine(OdDbObjectId geomDependencyId, bool bRay);
...
public:
  ...
  */
  ...
  OdConstrainedCircle(OdDbObjectId geomDependencyId);
...
public:
  ...
  /** \details
    Constructor creates an instance of this class.
  */
  OdConstrainedArc(bool bCreateImp = true);


  OdConstrainedArc(OdDbObjectId geomDependencyId);
...
public:
  ...
  */
  ...
  OdConstrainedEllipse(OdDbObjectId geomDependencyId);
...
public:
  ...
  /** \details
    Constructor creates an instance of this class.
  */
  OdConstrainedBoundedEllipse(bool bCreateImp = true);


  OdConstrainedBoundedEllipse(OdDbObjectId geomDependencyId);
...
public:
  ...
  /** \details
    Constructor creates an instance of this class.
  */
  OdConstrainedSpline(bool bCreateImp = true);


  OdConstrainedSpline(OdDbObjectId geomDependencyId, const OdGeNurbCurve3d& spline);
...
public:
  ...
  /** \details
    Constructor creates an instance of this class.
  */
  OdConstrainedRigidSet(bool bCreateImp = true);

  OdConstrainedRigidSet(bool bScalable, const OdGeMatrix3d& trans);
