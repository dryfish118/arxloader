...
class TOOLKIT_EXPORT OdDbServices : public OdRxService
{
public:
...
TOOLKIT_EXPORT OdResult oddbValidateSetup(const OdLocale& loc);
...
class ODRX_ABSTRACT TOOLKIT_EXPORT OdDbXObject : public OdRxObject
{
public:
...
//TODO
#if 1
class TOOLKIT_EXPORT OdCmComplexColor : public  OdDbXObject
{
public:
