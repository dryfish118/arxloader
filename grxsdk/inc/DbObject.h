...
TOOLKIT_EXPORT OdResult oddbResurrectMeNow(const OdDbObjectId& id);


class TOOLKIT_EXPORT OdDbObject : public OdGiDrawable, public OdHeapOperators
{
public:
...
public:
  ...
  */
  ...
  OdResult dxfOut(OdDbDxfFiler* pFiler,
    bool bAllXdata,
    const OdDbObjectIdArray *pRegAppIds) const;
  /** \details
  ...
  */
  virtual OdResBufPtr xDataPtr(
    const OdString& regappName = OdString::kEmpty) const;
  virtual resbuf* xData(const OdChar* regappName = nullptr) const;

  bool isUndoRecordingDisabled() const;

  bool hasReactor(const OdDbObjectReactor *pReactor) const;
  ...
  */
  virtual void setXDataPtr(
    const OdResBuf* pRb);
  virtual OdResult setXData(const resbuf* xdata);
