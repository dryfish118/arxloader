...
/** Description:
  ...
  \sa
  <link db_datasheet_sample_select, Example of Using the Record-Table Interface for Selecting Objects>
...
public:
  ...
  /** \details
    ...
    See: <link db_datasheet_add_delete, Adding, Naming, Deleting, Recovering Records>
  */
