...
#pragma pop_macro("new")
  ...
  */
  ...
  int toString(OdChar* buffer, size_t sizeInACHARs, OdRxValueType::StringFormat format = OdRxValueType::kStringFormatGlobal) const throw();
...
public:
  ...
  */
  virtual OdRxObject* clone() const ODRX_OVERRIDE;
  ...
  */
  virtual OdResult copyFrom(const OdRxObject* other) ODRX_OVERRIDE;
  ...
  */
  ...
  const OdRxObject* rxObject() const;
  OdRxObject* rxObject();
};
...
public:
  ...
  */
  OdRxBoxedValueOnStack(const OdRxValue& value);
