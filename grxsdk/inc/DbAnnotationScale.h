...
/** \details
    ...
    <group OdDb_Classes>
*/
class TOOLKIT_EXPORT OdDbAnnotationScale : public OdDbObjectContext, public OdHeapOperators
{
public:
 ...
 */
  virtual OdLongPtr uniqueIdentifier () const;
