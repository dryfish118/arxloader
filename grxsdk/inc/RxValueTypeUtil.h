...
public:
  ...
  */
  ...
  virtual int subToString(const void* instance, OdChar* buffer, size_t sizeInGCHARs, StringFormat format) const ODRX_OVERRIDE;
...
template<typename ValueType>
int OdRxValueTypePOD<ValueType>::subToString(const void* instance, OdChar* buffer, size_t sizeInGCHARs, OdRxValueType::StringFormat format) const
{
  return -1;
}
...
public:
  ...
  */
  ...
  virtual int subToString(const void* instance, OdChar* buffer, size_t sizeInGCHARs, OdRxValueType::StringFormat format) const;
  /** \details
    Compares two values of the underlying C++ type.
...
class OdRxNonBlittableType : public OdRxValueType
{
  ...
  */
  ...
  int subToString(const void* instance, OdChar* buffer, size_t sizeInGCHARs, OdRxValueType::StringFormat format) const ODRX_OVERRIDE
  {
    return -1;
  }
...
{\
  if (g_var)\
  {\
    ::odrxClassDictionary()->ODSYSCALL1(remove,__OD_T(#Name));\
    delete g_var;\
    g_var = 0;\
  }\
}
