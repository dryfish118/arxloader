...
public:
  ...
  */
  virtual void addHead(const OdChar * name, const OdChar * description, const OdChar * subLocation = NULL) = 0;
  ...
  /** \details
    ...
    \param subLocation [in]  Sublocation for the Hyperlink object.
  */
  virtual void addTail(const OdChar * name, const OdChar * description, const OdChar * subLocation = NULL) = 0;
  ...
  */
  virtual void addAt(const int hyperlinkIndex, const OdChar * name, const OdChar * description, const OdChar * subLocation = NULL) = 0;
  void addAt(int index, const OdDbHyperlink* pHLink);
...
public:
  ...
  */
  virtual OdResult setHyperlinkCollection(OdDbObject * pObject, OdDbHyperlinkCollection * pHCO) = 0;
...
#define GSTARTAPI_SERVICE  ODRX_T("GcadHyperlinks")
