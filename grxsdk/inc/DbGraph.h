...
public:
  OdDbGraphNode(void* pData = NULL) : m_pData(0), m_flags(0), m_pOwner(0) {}
  ...
  */
    ...
    OdUInt8 flags)
  {
    ...
    {
      return Oda::eInvalidInput; //throw OdError(eInvalidInput);
    }
  }
  ...
  */
  OdResult markTree(
    OdUInt8 flags, 
    OdDbVoidPtrArray* pNodeArray = NULL);
...
public:
  ...
  */
  OdResult push(
    OdDbGraphNode* pNode) { m_stack.push_back(pNode); return Oda::eOk;}
...
public:
  OdDbGraph(OdDbGraphNode* pRoot = NULL);
  virtual ~OdDbGraph();
  ...
  */
  ...
  void getOutgoing(OdDbVoidPtrArray& obj);
  /** \details
