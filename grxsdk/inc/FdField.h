...
public:
  ...
  OdFdFieldEvaluator(void);
  virtual ~OdFdFieldEvaluator(void);
  /** \details
  ...
  */
  virtual const OdChar * evaluatorId() const;
  /** \details
  ...
  */
  virtual const OdChar * evaluatorId(OdDbField* pField);
  /** \details
...
// evaluated field value as a string.
  ...
  */
  virtual OdResult format(OdDbField* pField, OdChar*& pszValue);
protected:
  OdFdFieldEvaluator(void*);
};
...
public:
  ...
  */
  virtual OdFdFieldEvaluator* getEvaluator(const OdChar * pszEvalId);
  ...
  */
  virtual OdFdFieldEvaluator * findEvaluator(OdDbField* pField, const OdChar *& pszEvalId);
};
...
public:
  ...
  */
  virtual OdResult beginEvaluateFields(int nContext, OdDbDatabase* pDb);
  ...
  /** \details
    ...
    \param pDb      [in] Input pointer to the database in which the fields are evaluated.
  */
  virtual OdResult endEvaluateFields(int nContext, OdDbDatabase* pDb);
};
...
public:
  ...
  */
  virtual OdResult registerEvaluatorLoader(OdFdFieldEvaluatorLoader* pLoader);
  ...
  */
  virtual OdResult unregisterEvaluatorLoader(OdFdFieldEvaluatorLoader* pLoader);

  /** \details
    Returns the number of registered field evaluator loaders.
    \returns Number of registered field evaluator loaders.
  */
  virtual int evaluatorLoaderCount() const;
...
public:
  ...
  */
  virtual OdResult setFieldValue(const OdValue* pValue);
  ...
  */
  virtual OdResult setEvaluationStatus(int errorStatus, int errorCode = 0, const OdChar* errorMessage = NULL);
};
