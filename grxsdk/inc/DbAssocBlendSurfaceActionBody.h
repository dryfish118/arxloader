...
public:
	...
	*/
  explicit OdDbAssocBlendSurfaceActionBody(OdDbAssocCreateImpObject createImpObject = kOdDbAssocCreateImpObject);
  ...
  */
  ...
  static OdResult createInstance(const OdDbObjectId& resultingSurfaceId,
    const OdDbLoftProfile* startProfile,
    const OdDbLoftProfile* endProfile,
    const OdDbBlendOptions& blendOptions,
    bool bEnabled,
  ...
  OdInt16  startEdgeContinuity(OdString& expression = dummyString(), OdString& evaluatorId = dummyString()) const;
  ...
  OdResult  setStartEdgeContinuity(OdInt16 value, const OdString& expression = OdString(),const OdString& evaluatorId = OdString());
  ...
  OdInt16  endEdgeContinuity(OdString& expression = dummyString(), OdString& evaluatorId = dummyString()) const;

  OdResult setEndEdgeContinuity(OdInt16 value, const OdString& expression = OdString(), const OdString& evaluatorId = OdString());
  ///// <summary><para> 
  ...
  double startEdgeBulge(OdString& expression = dummyString(), OdString& evaluatorId = dummyString()) const;

  OdResult setStartEdgeBulge(double value, const OdString& expression = OdString(), const OdString& evaluatorId = OdString());
	///// <summary><para> 
	///// Set bulge factor
	///// </para><para>
  ...
  double  endEdgeBulge(OdString& expression = dummyString(), OdString& evaluatorId = dummyString()) const;

  OdResult setEndEdgeBulge(double value, const OdString& expression = OdString(), const OdString& evaluatorId = OdString());
	///// <summary><para> 
  ...
  OdResult  getContinuityGripPoints(OdGePoint3d& startEdgePt,OdGePoint3d& endEdgePt) const;

  OdResult  getProfiles(OdDbLoftProfile* & pStartProfile, OdDbLoftProfile* & pEndProfile) const;
};
