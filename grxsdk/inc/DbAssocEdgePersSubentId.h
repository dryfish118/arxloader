...
public:
  ...
  */
  ...
  explicit OdDbAssocEdgePersSubentId(int vertexIdentifier1, int vertexIdentifier2);

  explicit OdDbAssocEdgePersSubentId(int vertexIdentifier1,
  ...
  */
  virtual OdDb::SubentType subentType(const OdDbEntity* pEntity, OdDbDatabase* pDatabase) const;
  ...
  */
  ...
  bool isSegmentArcCenter() const  {return !m_isMidPoint;}
  bool isSegmentMidpoint() const  {return m_isMidPoint;}
