...
inline OdUInt16 OdPlatformStreamer::rdUInt16(OdStreamBuf& streamBuf)
{
  OdUInt16 res;
  streamBuf.getBytes(&res, sizeof(res));
  odSwap2BytesNumber(res);
...
inline void OdPlatformStreamer::wrUInt16(OdStreamBuf& streamBuf, OdUInt16 val)
{
  odSwap2BytesNumber(val);
  streamBuf.putBytes(&val, sizeof(val));
}
