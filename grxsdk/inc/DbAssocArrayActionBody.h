...
public:
  ...
  */
  explicit OdDbAssocArrayActionBody(OdDbAssocCreateImpObject createImpObject = kOdDbAssocCreateImpObject);
  ...
  */
  ...
  virtual bool controlsItem(const OdDbAssocArrayItem& index) const;
