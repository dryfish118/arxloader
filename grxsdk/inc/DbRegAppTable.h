...
public:
  ...
  OdResult getRecord(OdDbRegAppTableRecord*& pRecord,
    OdDb::OpenMode openMode = OdDb::kForRead, bool openErasedRec = false) const;
...
public:
  ...
  */
  ...
  OdResult add(OdDbObjectId& recordId, OdDbRegAppTableRecord* pRecord);

  OdResult add(OdDbRegAppTableRecord* pRecord);

  virtual OdResult subGetClassID(
    CLSID* pClsid) const;
  
  OdResult newIterator(OdDbRegAppTableIterator*& pIterator,
