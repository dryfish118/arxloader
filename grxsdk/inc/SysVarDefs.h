...
/**
  ...
  <table>
   ...
   <b>Initial value</b>   false
   <b>Read-Only</b>       No
REGVAR_DEF(OdInt16, ATTMTEXTUSEDITDATA, (1), (), ValidateRange(0, 1))
...
DICR21VAR( OdInt16,                LIGHTINGUNITS,        (2),                     (2),                           (),                             ValidateRange(1,2)) // Default value since ACAD 2009 is 2 if drawing was created from scratch. But default acad template contains 0 value.
...
VAR_DEF( ODTDIST,               LENSLENGTH,           (50.),                     (50.),                             (),                           ValidatePositiveNonZero())
...
VAR_DEF(OdInt16, DIMTOFFSET, (1), (1), (), ValidateRange(0, 1))//add by ZhaoXuan for #72286
...
/**
  ...
  For example, to set the value:
  <code>
   OdRusBufPtr pRb = OdResBuf::newRb(OdResBuf::kRtDouble, -4.5);
   pDb-\>setSysVar(L"VSADRAFTANGLELOW", pRb);
   // or //
   pDb-\>setVSADRAFTANGLELOW(-5.0);
  </code>  
...
VAR_DEF(OdInt16,          EDUCHECKACTIVITY, (1), (1), (),ValidateRange(0, 1))
VAR_DEF(OdInt16,          TXTHATCH, (1), (1), (), ValidateRange(0, 1))
//新增变量}}
...
<group TD_SysVars_P>
  */
//<dom_var_def>OdInt16 PLOTTRANSPARENCYOVERRIDE;
...
REGVAR_DEF(OdUInt32,            MAXHATCHDENSITY,(100000),            (),       ValidateNone())
...
<group TD_SysVars_O>
  */
//<dom_var_def>OdInt16 OLEQUALITY;
...
/**
  <title LTGAPSELECTION>
  <toctitle LTGAPSELECTION>
  ...
  The LTGAPSELECTION variable specifies whether you can select or snap to the gaps on objects that have non-continuous linetype.
   
  <table>
   <b>Value</b>   <b>Description</b>
   false          Disables selection or snapping within gaps.
   true           Enables selection or snapping within gaps.
  </table>
...
<group TD_SysVars_L>
  */
//<dom_var_def>ODTBOOL LTGAPSELECTION;
REGVAR_DEF(ODTBOOL,   LTGAPSELECTION,     (0),                  (),        ValidateBOOL())

/**
  <title SELECTIONEFFECTCOLOR>
  <toctitle SELECTIONEFFECTCOLOR>
...
<group TD_SysVars_S>
  */
//<dom_var_def>OdInt16 SELECTIONEFFECTCOLOR;
REGVAR_DEF(OdInt16,   SELECTIONEFFECTCOLOR,   (0),                  (),        ValidateRange(0,255))

/**
  <title SELECTIONEFFECT>
  <toctitle SELECTIONEFFECT>
  ...
  <table>
  <b>Value</b>   <b>Description</b>
  0              Highlighted objects have dashed lines
  1              Glowing line highlighting effect is applied for highlighted objects when hardware acceleration is enabled
  </table>
...
<group TD_SysVars_S>
  */
//<dom_var_def>OdInt16 SELECTIONEFFECT;
REGVAR_DEF(OdInt16,   SELECTIONEFFECT,        (1),                  (),        ValidateRange(0,1))
...
/**
  ...
  <group TD_SysVars_A>
*/
//<dom_var_def>OdInt16 AcisProxyMode;
...
*/
REGVAR_DEF(bool,                DxfTextAdjustAlignment,  (true),               (),       ValidateBOOL())
...
REGVAR_DEF(OdInt16,              MtMode,  (3),               (),       ValidateNone())
...
*/
REGVAR_DEF(OdInt16,              XREFREGAPPCTL,                (0),                             (0),       ValidateRange(0,1))
