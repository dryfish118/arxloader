...
public:
  ...
  OdResult setHeight(double val);

  OdResult setWidth(double val);
  ...
  OdBool isImageShown() const;

  void setShowImage(OdBool value);

  OdBool isImageTransparent() const;

  void setImageTransparency(OdBool value);

  OdBool isShownClipped() const;

  void setShowClipped(OdBool value);
  ...
  */
  virtual OdResult setImageDefId(
  ...
  */
  virtual OdResult setClipBoundary(
    const OdGePoint2dArray& clipPoints);

  virtual OdResult setClipBoundary(ClipBoundaryType type,
    const OdGePoint2dArray& clipPoints);
  /** \details
  ...
  */
  virtual OdResult setClipBoundaryToWholeImage();

  virtual OdResult setClipBoundaryToWholeImage(OdGeVector2d& size);
