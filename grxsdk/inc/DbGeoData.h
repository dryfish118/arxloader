...
class TOOLKIT_EXPORT OdDbGeoDataReactor
{
public:
  virtual ~OdDbGeoDataReactor()
  {
  }
  virtual OdResult geoCoordinateSystemWillChange(OdDbDatabase*, const OdString&, const OdString&)
  {
    return eOk;
  }
  virtual void geoCoordinateSystemChanged(OdDbDatabase*, const OdString&, const OdString&)
  {
  }
};
...
* kCoordTypGeographic 
  ...
  */
  ...
  typedef bool(*ODDBGEODATA_VALIDATE_CS)(const OdChar* coordinateSystem);
  static OdResult setValidateCoordinateSystemCallback(ODDBGEODATA_VALIDATE_CS pFuncValidateCs);

  static ODDBGEODATA_VALIDATE_CS getValidateCoordinateSystemCallback();

  typedef OdResult(*ODDBGEODATA_GEOGRAPHICTODWG)(const OdDbGeoData* pGeoData,
  ...
  typedef OdResult(*ODDBGEODATA_DWGTOGEOGRAPHIC)(const OdDbGeoData* pGeoData,
  ...
  static  OdResult setTransformCallbacks(const OdChar* zoneDescription,
    ODDBGEODATA_GEOGRAPHICTODWG pFuncGeoToDwg,
    ODDBGEODATA_DWGTOGEOGRAPHIC pFuncDwgToGeo);

  static  const OdChar* getTransformCallbacks(ODDBGEODATA_GEOGRAPHICTODWG& pFuncGeoToDwg,
    ODDBGEODATA_DWGTOGEOGRAPHIC& pFuncDwgToGeo);
  ...
  */
  OdResult getMeshFace(int faceIndex, int & p0, int & p1, int & p2) const;
  /** \details
  ...
  */
  OdResult addMeshFace(int faceIndex, int p0, int p1, int p2);
