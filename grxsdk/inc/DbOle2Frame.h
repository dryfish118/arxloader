...
public:
  ...
  */
  virtual void getLocation(OdGePoint3d&
    point3d) const;
  ...
  */
  ...
  void getUserType(OdString & str) const;
  ...
  */
  ...
  OdResult getLinkPath(OdString &str) const;
  ...
  */
  OdResult setWcsWidth(double fWidth);
  ...
  */
  OdResult setWcsHeight(double fHeight);
  ...
  */
  OdResult setScaleWidth(double fScale);
  ...
  */
  OdResult setScaleHeight(double fScale);
  ...
  */
  ...
  /** \details
    ...
    \param bFlag [in]  New value.
  */
  OdResult setLockAspect(const bool bLockAspect);
