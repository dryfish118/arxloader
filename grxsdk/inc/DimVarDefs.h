...
/**
  ...
  DIMADEC specifies the number of decimal places in angular dimensions. If DIMADEC == ?, the number of decimal places is
...
VAR_DEF(OdInt16,              adec,   179,    (0),                  (0),                  ADEC,        ValidateRange(0, 8),OdInt,OdInt)
...
VAR_DEF(bool,                 alt,    170,    (false),              (false),              ALT,        ValidateNone(), bool, bool)
...
VAR_DEF(OdUInt16,             altd,   171,    (2),                  (3),                  ALTD,        ValidateRange(0,8), OdInt, OdInt)
...
VAR_DEF(double,               altf,   143,    (25.4),               (0.03937007874016),   ALTF,        ValidateRange(DBL_MIN, DBL_MAX),double, double)
...
VAR_DEF(ODTDIST,              altrnd, 148,    (0.0),                (0.0),                ALTRND,        ValidateRange(0,DBL_MAX), ODTDIST, ODTDIST)
...
VAR_DEF(OdInt16,              alttd,  274,    (2),                  (3),                  ALTTD,        ValidateRange(0,8), OdInt, OdInt)
...
VAR_DEF(OdUInt8,              alttz,  286,    (0),                  (0),                  ALTTZ,        ValidateRange(0,15), OdInt, OdInt)
...
VAR_DEF(OdInt16,              altu,   273,    (2),                  (2),                  ALTU,        ValidateRange(1,8), OdInt, OdInt)
...
VAR_DEF(OdUInt8,              altz,   285,    (0),                  (0),                  ALTZ,        ValidateRange(0,15), OdInt, OdInt)
...
VAR_DEF(OdString,             apost,  4,      (OD_T("")),                 (OD_T("")),                 APOST,        ValidateNone(),const OdChar*, const OdChar*)
...
VAR_DEF(ODTDIST,              asz,    41,     (0.18),               (2.5),                ASZ,        ValidateRange(0,DBL_MAX), ODTDIST, ODTDIST)
...
ANNOVAR_DEF(OdInt16,          atfit,  289,    (3),                  (3),                  ATFIT,        ValidateRange(0,3), OdInt, OdInt)
...
VAR_DEF(OdInt16,              aunit,  275,    (0),                  (0),                  AUNIT,        ValidateRange(0,4), OdInt, OdInt)
...
VAR_DEF(OdInt16,              azin,   79,     (0),                  (0),                  AZIN,        ValidateRange(0,3), OdInt, OdInt)
...
BLKVAR_DEF(ODTARROWBLK,       blk,    342,    (OdDbObjectId::kNull),(OdDbObjectId::kNull),BLK,        ValidateDimBlock(),OdDbObjectId, OdDbObjectId)
...
BLKVAR_DEF(ODTARROWBLK,       blk1,   343,    (OdDbObjectId::kNull),(OdDbObjectId::kNull),BLK1,        ValidateDimBlock(),OdDbObjectId, OdDbObjectId)
...
BLKVAR_DEF(ODTARROWBLK,       blk2,   344,    (OdDbObjectId::kNull),(OdDbObjectId::kNull),BLK2,        ValidateDimBlock(),OdDbObjectId, OdDbObjectId)
...
VAR_DEF(ODTDIST,              cen,    141,    (0.09),               (2.5),                CEN,        ValidateNone(), ODTDIST, ODTDIST)
...
VAR_DEF(ODCMCOLORACI,            clrd,   176,(OdCmEntityColor::kByBlock),(OdCmEntityColor::kByBlock),CLRD,ValidateAciColor(),ODCMCOLORACI,const OdCmColor&)
...
VAR_DEF(ODCMCOLORACI,            clre,   177,(OdCmEntityColor::kByBlock),(OdCmEntityColor::kByBlock),CLRE,ValidateAciColor(), ODCMCOLORACI, const OdCmColor&)
...
VAR_DEF(ODCMCOLORACI,            clrt,   178,(OdCmEntityColor::kByBlock),(OdCmEntityColor::kByBlock),CLRT,ValidateAciColor(), ODCMCOLORACI, const OdCmColor&)
...
VAR_DEF(OdInt16,              dec,    271,    (4),                  (2),                  DEC,        ValidateRange(0,8), OdInt, OdInt)
...
VAR_DEF(ODTDIST,              dle,    46,     (0.0),                (0.0),                DLE,        ValidateRange(0,DBL_MAX), ODTDIST, ODTDIST)
...
VAR_DEF(ODTDIST,              dli,    43,     (0.38),               (3.75),               DLI,        ValidatePositive(), ODTDIST, ODTDIST)
...
VAR_DEF(ODTDECSEP,            dsep,   278,    ('.'),                (','),                DSEP,        ValidateDecSep(),OdChar,OdChar)
...
VAR_DEF(ODTDIST,              exe,    44,     (0.18),               (1.25),               EXE,        ValidatePositive(), ODTDIST, ODTDIST)
...
VAR_DEF(ODTDIST,              exo,    42,     (0.0625),             (0.625),              EXO,        ValidatePositive(), ODTDIST, ODTDIST)
...
VAR_DEF(OdInt16,              frac,   276,    (0),                  (0),                  FRAC,        ValidateRange(0,2), OdInt, OdInt)
...
VAR_DEF(ODTDIST,              gap,    147,    (0.09),               (0.625),              GAP,        ValidateNone(), ODTDIST, ODTDIST)
...
VAR_DEF(OdUInt16,             just,   280,    (0),                  (0),                  JUST,        ValidateRange(0,4), OdInt, OdInt)
...
VAR_DEF(ODTARROWBLK,          ldrblk, 341,    (OdDbObjectId::kNull),(OdDbObjectId::kNull),LDRBLK,        ValidateDimBlock(),OdDbObjectId, OdDbObjectId)
...
VAR_DEF(double,               lfac,   144,    (1.0),                (1.0),                LFAC,        ValidateNone(), double, double)
...
VAR_DEF(bool,                 lim,    72,     (false),              (false),              LIM,        ValidateNone(), bool, bool)
...
VAR_DEF(OdInt16,              lunit,  277,    (2),                  (2),                  LUNIT,        ValidateRange(1,6), OdInt, OdInt)
...
VAR_DEF(ODTDB_LINEWEIGHT,     lwd,    371,    (OdDb::kLnWtByBlock), (OdDb::kLnWtByBlock), LWD,        ValidateLineWeight(), ODTDB_LINEWEIGHT, ODTDB_LINEWEIGHT)
...
VAR_DEF(ODTDB_LINEWEIGHT,     lwe,    372,    (OdDb::kLnWtByBlock), (OdDb::kLnWtByBlock), LWE,        ValidateLineWeight(), ODTDB_LINEWEIGHT, ODTDB_LINEWEIGHT)
...
VAR_DEF(OdString,             post,   3,      (OD_T("")),                 (OD_T("")),                 POST,        ValidateNone(),const OdChar*, const OdChar*)
...
VAR_DEF(ODTDIST,              rnd,    45,     (0.0),                (0.0),                RND,        ValidatePositive(), ODTDIST, ODTDIST)
...
VAR_DEF(bool,                 sah,    173,    (false),              (false),              SAH,        ValidateNone(), bool, bool)
...
VAR_DEF(double,               scale,  40,     (1.0),                (1.0),               SCALE,        ValidatePositive(), double, double)
...
VAR_DEF(bool,                 sd1,    281,    (false),              (false),              SD1,        ValidateNone(), bool, bool)
...
VAR_DEF(bool,                 sd2,    282,    (false),              (false),              SD2,        ValidateNone(), bool, bool)
...
VAR_DEF(bool,                 se1,    75,     (false),              (false),              SE1,        ValidateNone(), bool, bool)
...
VAR_DEF(bool,                 se2,    76,     (false),              (false),              SE2,        ValidateNone(), bool, bool)
...
ANNOVAR_DEF(bool,             soxd,   175,    (false),              (false),              SOXD,        ValidateNone(), bool, bool)
...
VAR_DEF(OdInt16,              tad,    77,     (0),                  (1),                  TAD,        ValidateRange(0,4), OdInt, OdInt)
...
VAR_DEF(OdInt16,              tdec,   272,    (4),                  (2),                  TDEC,        ValidateRange(0,8), OdInt, OdInt)
...
VAR_DEF(double,               tfac,   146,    (1.0),                (1.0),                TFAC,        ValidatePositiveNonZero(), double, double)
...
VAR_DEF(bool,                 tih,    73,     (true),               (false),              TIH,        ValidateNone(), bool, bool)
...
ANNOVAR_DEF(bool,             tix,    174,    (false),              (false),              TIX,        ValidateNone(), bool, bool)
...
VAR_DEF(ODTDIST,              tm,     48,     (0.0),                (0.0),                TM,        ValidateNone(), ODTDIST, ODTDIST)
...
ANNOVAR_DEF(OdInt16,          tmove,  279,    (0),                  (0),                  TMOVE,        ValidateRange(0,2), OdInt, OdInt)
...
ANNOVAR_DEF(bool,             tofl,   172,    (false),              (true),               TOFL,        ValidateNone(), bool, bool)
...
VAR_DEF(bool,                 toh,    74,     (true),               (false),              TOH,        ValidateNone(), bool, bool)
...
VAR_DEF(bool,                 tol,    71,     (false),              (false),              TOL,        ValidateNone(), bool, bool)
...
VAR_DEF(OdUInt8,              tolj,   283,    (1),                  (0),                  TOLJ,        ValidateRange(0,2), OdInt, OdInt)
...
VAR_DEF(ODTDIST,              tp,     47,     (0.0),                (0.0),                TP,        ValidateNone(), ODTDIST, ODTDIST)
...
VAR_DEF(ODTDIST,              tsz,    142,    (0.0),                (0.0),                TSZ,        ValidatePositive(), ODTDIST, ODTDIST)
...
VAR_DEF(double,               tvp,    145,    (0.0),                (0.0),                TVP,        ValidateNone(), double, double)
...
VAR_DEF(ODTTEXTSTYLEID,       txsty,  340,    (OdDbObjectId::kNull),(OdDbObjectId::kNull), TXSTY,        ValidateTextStyle(), OdDbObjectId, OdDbObjectId)
...
VAR_DEF(ODTDIST,              txt,    140,    (0.18),               (2.5),                TXT,        ValidatePositiveNonZero(), ODTDIST, ODTDIST)
...
VAR_DEF(OdUInt8,              tzin,   284,    (0),                  (8),                  TZIN,        ValidateRange(0,15), OdInt, OdInt)
...
VAR_DEF(bool,                 upt,    288,    (false),              (false),              UPT,        ValidateNone(), bool, bool)
...
VAR_DEF(OdUInt8,              zin,    78,     (0),                  (8),                  ZIN,        ValidateRange(0,15), OdInt, OdInt)
...
VAR_DEF(ODTDIST,              fxlen,    49,     (1.0),                  (1.0),                  FXLEN,        ValidateNone(), ODTDIST, ODTDIST)
...
VAR_DEF(bool,              fxlenOn,    290,     (false),                  (false),                  FXLENON,       ValidateBOOL(), bool, bool)
...
VAR_DEF(ODTORIENT,         jogang,    50,     (OdaPI4),                  (OdaPI4),                  JOGANG,     ValidateRange(  5.0*OdaPI/180.0, OdaPI2), ODTORIENT, ODTORIENT)
...
VAR_DEF(OdInt16,              tfill,    69,     (0),                  (0),                  TFILL,        ValidateRange(0, 2), OdInt, OdInt)
...
VAR_DEF(ODCMCOLORACI,              tfillclr,    70,     (OdCmEntityColor::kByBlock),                  (OdCmEntityColor::kByBlock),                  TFILLCLR,        ValidateAciColor(), ODCMCOLORACI, const OdCmColor&)
...
VAR_DEF(OdInt16,              arcsym,    90,     (0),                  (0),                  ARCSYM,        ValidateRange(0, 2), OdInt, OdInt)
...
VAR_DEF(ODTLINETYPEID,              ltype,    345,     (OdDbObjectId::kNull),                  (OdDbObjectId::kNull),                  LTYPE,        ValidateLinetype(true), OdDbObjectId, OdDbObjectId)
...
VAR_DEF(ODTLINETYPEID,              ltex1,    346,     (OdDbObjectId::kNull),                  (OdDbObjectId::kNull),                  LTEX1,        ValidateLinetype(true), OdDbObjectId, OdDbObjectId)
...
VAR_DEF(ODTLINETYPEID,              ltex2,    347,     (OdDbObjectId::kNull),                  (OdDbObjectId::kNull),                  LTEX2,        ValidateLinetype(true), OdDbObjectId, OdDbObjectId)
...
*/
VAR_DEF(bool,         txtdirection,   294,          (false),                  (false),          TXTDIRECTION,  ValidateBOOL(), bool, bool)
...
*/
VAR_DEF(double,                mzf,   297,          (100.0),                  (100.0),          MZF,  ValidateNone(), double, double)
...
*/
VAR_DEF(OdString,              mzs,   298,       (OD_T("")),               (OD_T("")),          MZS,  ValidateNone(),const OdChar*, const OdChar*)
...
*/
VAR_DEF(double,             altmzf,   295,          (100.0),                  (100.0),          ALTMZF,  ValidateNone(), double, double)
...
*/
VAR_DEF(OdString,           altmzs,   296,       (OD_T("")),               (OD_T("")),          ALTMZS,  ValidateNone(),const OdChar*, const OdChar*)
