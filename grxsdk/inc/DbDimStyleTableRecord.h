...
namespace OdDmUtil
{
  ...
  */
  ...
  DBLIB_EXPORT const OdChar * globalArrowName(const OdChar * pName);
  DBLIB_EXPORT const OdChar * globalArrowName(OdDbObjectId blockId);
  /** \details
  ...
  */
  ...
  DBLIB_EXPORT OdResult findArrowId(const OdChar * pName,
    OdDbObjectId& blockId,
    OdDbDatabase* pDb = 0);
  /** \details
  ...
  */
  ...
  OdResult TOOLKIT_EXPORT getArrowId(
    const OdString& arrowheadName,
    OdDbObjectId& blockId,
    OdDbDatabase* pDb = 0);
...
/*DOM-IGNORE-END*/
  ...
  virtual OdResult setDimblk(const OdChar* val);

  virtual OdResult setDimblk1(const OdChar* val);

  virtual OdResult setDimblk2(const OdChar* val);

  virtual OdResult setDimldrblk(const OdChar* val);

  // 2005-2006 support
  
  /** \details
    Returns the background text color and flags for this Dimension Style. The
  ...
  */
  ...
  /** \details
    Sets the background text color and flags for this Dimension Style. The
    background text flags value specifies the background fill of dimension text.
