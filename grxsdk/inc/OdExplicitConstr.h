...
public:
  ...
  */
  ...
  /** \details
    Constructor creates an instance of this class.
  */
  OdDistanceConstraint(bool bCreateImp = true);
  OdDistanceConstraint(const OdGeVector3d& direction);
  OdDistanceConstraint(const OdGraphNode::Id consLineId, DirectionType type = kPerpendicularToLine);
...
public:
  ...
  */
  ...
  /** \details
    Constructor creates an instance of this class.
  */
  OdAngleConstraint(bool bCreateImp = true);
...
public:
  ...
  /** \details
    Constructor creates an instance of this class.
  */
  Od3PointAngleConstraint(bool bCreateImp = true);
...
public:
  ...
  */
  ...
  /** \details
    Constructor creates an instance of this class.
  */
  OdRadiusDiameterConstraint(bool bCreateImp = true);
