...
public:  
  ...
  */
  ...
  virtual OdResult getEdgeSubentityGeometry(OdArray<OdUInt32> indexesOfEdgeCalculation, OdGeCurve3d*& pEdgeCurve) { return Oda::eNotImplemented; }
  ...
  */
  ...
  /** \details
    ...
    \returns eNotImplemented.
  */
  virtual OdResult generateMesh(const OdBrMesh2dFilter& filter, OdBrMesh2d &mesh2d) { return Oda::eNotImplemented; }
  ...
  */
  ...
  /** \details
    ...
    \param result               [out] (Optional) Receives pointer to the resulting ModelerGeometry object.
    ...
    The result is saved in this ModelerGeometry object.
  */
  virtual OdResult booleanOper(OdDbDatabase* database, OdDb::BoolOperType operation, const OdModelerGeometry* otherBody,
    geomType typeThis, geomType typeOther, OdSmartPtr<OdModelerGeometry>* result = NULL, OdDbEntityPtrArray* intersectionEntities = NULL,
    const OdCmColor & thisEntColor = OdCmColor(OdCmEntityColor::kNone), const OdCmColor& otherEntColor = OdCmColor(OdCmEntityColor::kNone), bool bHistoryEnabled = false) = 0;
  ...
  */
  ...
  /** \details
    ...
    pointed to by commonVolumeSolid (resulting from intersection of this solid
    and otherSolid) when the function finishes.
    If commonVolumeSolid is added to a database, the database takes
    responsibility for the memory pointed to by commonVolumeSolid.
    If commonVolumeSolid is not added to a database, the caller must free memory
    when it is no longer needed to avoid a memory leak.
  */
  ...
  */
  ...
  /** \details
    ...
    \param pFromEntity [in] Pointer to either a planar entity with thickness, a
                            simple closed planar entity, or an OdDbSolid entity
  ...
  */
  ...
  /** \details
    Creates new entities that represent the result of interference between this
    ModelerGeometry object and a specified entity. Created entities are appended
    to the specified array.

    \param interferenceObjects [out] Output array of interference entities.
    \param pEntity              [in] Pointer to the entity the object must
                                     interfere with. pEntity can point to the
  ...
  */
  ...
  /** \details
    ...
    \returns eNotImplemented.
  */
  virtual OdResult setMaterialResolver(const OdMaterialResolver *pResolver) { return Oda::eNotImplemented; }
  ...
  */
  ...
  OdArray<OdDbSubentId*>& faceSet, OdUInt32 flags = 0, const OdGeTol &tol = OdGeTol(1.0e-6) ) { return Oda::eNotImplemented; }
  ...
  */
  ...
  /** \details
    ...
    \param backgroundEnts       [out] Array of resut entities after se駎ion array of entities pEnts.
  ...
  */
  ...
  /** \details
    ...
    \returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult createCachedCurves(OdGeCurve3dPtrArray& pCurves){ return Oda::eNotImplemented; }
  ...
  /** \details
    ...
    \returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult restoreAttributes(OdModelerGeometry* oldmodeler){ return Oda::eNotImplemented; }
  ...
  /** \details
    ...
    \returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult addSubentitySpecialSettings(AcisDataType addedDT, AcisDataTypeArrFirst addedDTFirst, const OdDbSubentId subentId, OdArray<OdUInt32>& retArray, OdUInt32 idx){ return Oda::eNotImplemented; }
  ...
  */
  ...
  /** \details
    ...
    \returns eNotImplemented.
  */
  virtual OdResult auditAcisData(OdDbAuditInfo* pInfo, const OdRxObject* pObj) { return Oda::eNotImplemented; }
  ...
  */
  ...
  virtual OdResult surfOffsetMarkers(const OdModelerGeometry::NumIsolines& numIsolines, OdGePoint3dArray& ptns, OdGeVector3dArray& vecs) { return Oda::eNotImplemented; }
  
  virtual OdResult getCvaddControlPoints(double dVal, int iUorV, OdGePoint3dArray& ptns, OdGeDoubleArray& weights) { return Oda::eNotImplemented; }
