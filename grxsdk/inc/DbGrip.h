...
typedef const OdChar * (*GripCLIPromptPtr)(OdDbGripData* pThis);
typedef const OdChar * (*GripCLIDisplayStringPtr)(OdDbGripData* pThis);
...
typedef OdDbGripOperations::ReturnValue(*GripRightClickHandler)(
  OdDbGripDataArray& hotGrips,
  const OdDbObjectIdArray& ents, OdRxObject*& handler);
...
public:
  ...
  */
  ...
  OdRxClass* appDataAcRxClass() const;

  void setAppDataAcRxClass(OdRxClass* pClass);
...
inline OdDbGripData::OdDbGripData(const OdDbGripData& srcData)
{
  ...
  m_pRtClk.oldHandler     = srcData.rtClk();
...
inline OdDbGripData& OdDbGripData::operator = (const OdDbGripData& rightSide)
{
  ...
  m_pRtClk.oldHandler     = rightSide.rtClk();
  ...
  m_pObjectData           = rightSide.m_pObjectData;
...
inline GripRightClickHandler OdDbGripData::righClick() const
{
  //ODA TODO
  return m_pRtClk.newHandler;
}

inline void OdDbGripData::setRightClick(GripRightClickHandler pFunc)
{
  //ODA TODO
  m_pRtClk.newHandler = pFunc;
}

inline GripCLIPromptPtr OdDbGripData::getCLIPromptFunc()const
{
  //ODA TODO
  return m_pCLIPromptFunc;
}

inline void OdDbGripData::setCLIPromptFunc(GripCLIPromptPtr pFunc)
{
  //ODA TODO
  m_pCLIPromptFunc = pFunc;
}

inline GripCLIDisplayStringPtr OdDbGripData::getCLIDisplayStringFunc()const
{
  //ODA TODO
  return m_pCLIDisplayStringFunc;
}

inline void OdDbGripData::setCLIDisplayStringFunc(GripCLIDisplayStringPtr pFunc)
{
  //ODA TODO
  m_pCLIDisplayStringFunc = pFunc;
}

inline bool OdDbGripData::gripIsDisabled() const
{
  return !!(m_bitFlags & OdDbGripOperations::kGripIsDisabled);
}

inline void OdDbGripData::disableGrip(bool disable)
{
  if (disable)
    m_bitFlags |= OdDbGripOperations::kGripIsDisabled;
  else
    m_bitFlags &= ~OdDbGripOperations::kGripIsDisabled;
}

inline bool OdDbGripData::gripRightClickIsNewStyle() const
{
  return !!(m_bitFlags & OdDbGripOperations::kGripRightClickIsNewStyle);
}

inline OdRxClass* OdDbGripData::appDataAcRxClass() const
{
  return m_pAppDataClass;
}

inline void OdDbGripData::setAppDataAcRxClass(OdRxClass* pClass)
{
  m_pAppDataClass = pClass;
}
...
{
  m_bitFlags &= ~OdDbGripOperations::kGripRightClickIsNewStyle;
  m_pRtClk.oldHandler = pf;
}
