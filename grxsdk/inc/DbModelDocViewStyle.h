...
public:
  ...
  */
  ...
  virtual OdResult getName(OdString& strName) const;
  /** \details
  ...
  */
  ...
  virtual void getDescription(OdString& strDescription) const;
  /** \details
  ...
  */
  ...
  OdResult postViewStyleToDb(OdDbDatabase* pDb,
    const OdChar* styleName,
    OdDbObjectId &viewStyleId);
  ...
  static OdGePoint3d calculateViewLabelPosition(OdGeVector2d &offsetVector,
    ...
    double offset, const OdGePoint3d &minPt,
    const OdGePoint3d &maxPt);

  static OdGeVector2d setViewLabelPosition(OdDbMText *pMText,
    OdDbModelDocViewStyle::AttachmentPoint attachment,
    double offset, const OdGePoint3d &minPt, const OdGePoint3d &maxPt);
 
  static OdGeVector2d updateViewLabelPosition(OdDbMText *pMText,
    OdDbModelDocViewStyle::AttachmentPoint &attachment,
    const OdGePoint3d &minPt, const OdGePoint3d &maxPt);
...
protected:
  virtual OdResult subDeepClone(OdDbObject* pOwner, OdDbObject*& pClonedObject, OdDbIdMapping& idMap, OdBool isPrimary = true) const;
  virtual OdResult subWblockClone(OdRxObject* pOwner, OdDbObject*& pClonedObject, OdDbIdMapping& idMap, OdBool isPrimary = true) const;
