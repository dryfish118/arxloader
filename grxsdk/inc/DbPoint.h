...
/** \details
  ...
  \sa
  <link db_point_sample, Example of Working with the Point Object>

  \sa
  <link db_point, Working with Points>

  <link db_point_appearance, Appearance and Size of Points>
*/
...
public:
  ...
  /** \details
    ...
    See: <link db_point_overview, Overview of Points>
  */
  OdDbPoint();
  ...
  /** \details
    ...
    \sa
    <link db_point_specific, Specific Point Properties>
  ...
  */
  OdResult setPosition( const OdGePoint3d& gePoint );
  ...
  */
  OdResult setEcsRotation( double vAngle );
