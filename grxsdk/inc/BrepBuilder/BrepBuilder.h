...
public:
  ...
  */
  ...
  /** \details
    Sets the tag value that is used for faces and edges. MODE: kSetTagMode.
    ...
    \remarks
    kSetTagMode and kAutoMode are incompatible. You cannot use methods setTag()
    and setInitialTag() at the same time.
  */
