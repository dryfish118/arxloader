...
public:
  ...
  */
  virtual OdGiDrawable::DrawableType lightType() const;
  ...
  */
  virtual OdResult setLightType(OdGiDrawable::DrawableType type);
  ...
  */
  virtual OdResult setIsPlottable(bool plot);

  /** \details
    Retrieves the color of this light.
  */
  virtual const OdCmColor& lightColor() const;
  ...
  */
  virtual OdResult setLightColor(const OdCmColor& color);
  ...
  */
  OdResult setShadowParameters(const OdGiShadowParameters& params);
  
  /** \details
    Retrieves the shadow parameters of this light.
  */
  const OdGiShadowParameters &shadowParameters() const;
  OdResult shadowParameters(OdGiShadowParameters& shadowParams) const;
  ...
  */
  virtual void setLightAttenuation(const OdGiLightAttenuation& params);
  
  /** \details
    Retrieves the attenuation parameters of this light.
  */
  virtual const OdGiLightAttenuation &lightAttenuation() const;
  ...
  */   
  virtual OdResult setPosition(const OdGePoint3d& pos);
  
  /** \details
    Retrieves the position for point light and spot light sources.
  */        
  virtual const OdGePoint3d& position() const;
  ...
  */
  virtual const OdGePoint3d& targetLocation() const;
  ...
  */
  virtual OdResult setTargetLocation(const OdGePoint3d& newVal);
  ...
  */
  virtual OdResult setHotspotAndFalloff(double hotspot, double falloff);
  ...
  */  
  virtual const OdGeVector3d& lightDirection() const;
  ...
  */
  virtual OdResult setLightDirection(const OdGeVector3d& lightvec);
  ...
  */
  OdResult setLampColorRGB(const OdGiColorRGB &color);
  ...
  */
  OdResult setWebFile(const OdString &webFile);
  ...
  */
  OdResult setWebRotation(const OdGeVector3d &rotation);
  ...
  */
  OdResult setGlyphDisplay(GlyphDisplayType type);
