...
public:
  ...
  */
  ...
  virtual OdResult subHighlight(const OdDbFullSubentPath& subId = kNullSubent, OdBool highlightAll = false) const;
...
public:
  ...
  virtual OdResult setLayer(const OdChar* newVal,
...
public:
  ...
  OdChar* getSubentPlotStyleName(const OdDbSubentId& subentId) const;
