...
/** \details
  ...
  \sa
  <link db_color_sample_dictionary, Example of Working with the Color Dictionary Object>

  <link db_color_sample_object, Example of Entering and Displaying for Color Objects>

  \sa
  <link cm_concept, Concept of Colors>

  <link db_color_concept, Concept of Database Colors>

  <link OdCmColor, OdCmColor class>
*/
...
public:
  ...
  /** \details
    ...
    See: <link db_color_manipulate, Manipulating Objects of the Color Dictionary>
  */
  OdDbColor();
  virtual ~OdDbColor();
  ...
  /** \details
    ...
    \sa
    <link db_color, Working with Colors>
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link cm_color_sample_entity, Example of Working with the Entity Color>
