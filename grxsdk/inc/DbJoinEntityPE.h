...
public:
  ...
  */
  virtual OdResult joinEntities(OdDbEntity* primaryEntity, const OdArray<OdDbEntity*>& otherEntities, OdGeIntArray& joinedEntityIndices, const OdGeTol& tol = OdGeContext::gTol) const = 0;
  ...
  */
  virtual OdResult joinEntity(OdDbEntity* primaryEntity, OdDbEntity* secondaryEntity, const OdGeTol& tol = OdGeContext::gTol) const;
};
