...
public:     
  ...
  */
  explicit OdDbAssocVariable(OdDbAssocCreateImpObject createImpObject = kOdDbAssocCreateImpObject);
  ...
  */
  ...
  const OdString& expression(bool convertSymbolNamesFromCanonicalForm) const;
  ...
  */
  ...
  const OdDbEvalVariant& value() const;
  ...
  */
  OdResult setExpression(const OdString& newExpression,
    ...
    OdString& errorMessage = dummyString(),
  ...
  */
  ...
  static OdResult evaluateExpression(const OdString& expression,
                              const OdString&  evaluatorId,
                              const OdDbObjectId& networkId,
                              OdDbEvalVariant& evaluatedExpressionValue,
                              OdString& assignedToSymbolName,
                              OdString& errorMessage = dummyString());
  /** \details
