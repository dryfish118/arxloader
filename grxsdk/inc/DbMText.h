...
struct OdDbMTextFragment
{
  ...
  OdChar* text;                  // Text string.

  OdChar* font;                  // SHX Font.
  OdChar* bigfont;               // SHX Bigfont.
  ...
  OdChar*  fontname;             // TrueType font name, or empty string.
...
/** \details
    ...
    \sa
    <link db_text_multi, Working with Multi-Line Text>
...
public:
  ...
  */
  OdResult setLocation(const OdGePoint3d& location);
  ...
  */  
  double rotation(ODSYSDEF) const;
  ...
  */
  OdResult setRotation(ODSYSDEF,double rotation);
  ...
  */
  OdResult setTextStyle(OdDbObjectId textStyleId);
  ...
  */
  OdResult setTextHeight(double height);
  ...
  */
  OdResult setFlowDirection(FlowDirection flowDirection);
...
*/
  ...
  */
  OdResult setLineSpacingStyle(OdDb::LineSpacingStyle lineSpacingStyle);
  ...
  */
  OdResult setBackgroundFill(bool bEnable);
  ...
  */
  ...
  OdResult setStaticColumns(double width, double gutter, OdInt16 count);
  ...
  */
  OdResult setColumnCount(OdInt32 numCol);
  ...
  */
  OdResult getColumnHeight(int col, double& val) const;
  ...
  */
  OdResult setColumnHeight(int col, double colHeight);
