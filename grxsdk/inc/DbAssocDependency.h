...
public: 
  ...
  */
  explicit OdDbAssocDependency(OdDbAssocCreateImpObject createImpObject = kOdDbAssocCreateImpObject);
  ...
  */
  ...
  static OdResult getFirstDependencyOnObject(const OdDbObject* pObject,
    OdDbObjectId& firstDependencyId);

  /** \details
    Gets all dependency objects that are dependent on the given object.
  */
  static OdResult getDependenciesOnObject(const OdDbObject* pObject,
  ...
  */
  ...
  OdResult transferToObject(const OdDbCompoundObjectId& compoundId);
...
public:
  ...
  */
  ...
  explicit OdDbAssocDependencyNotificationDisabler(bool disableIt = true);
  /** \details
    Destructor.
  */
