...
/** \details
  ...
  \sa
  <link db_rb, Working with Tagged Data>
...
/** \details
  ...
  * RbNext:  A smart pointer to the ResBuf instance to be attached in a linked list.
  ...
  \sa
  <link db_rb_sample_codes, Example of Entering and Displaying Tagged Data>

  <link db_rb_sample_sequence, Example of Working with the Sequence of Tagged Data>

  \sa
  <link db_rb, Working with Tagged Data>

  <link db_xdata, Working with Extended Data>

  <link db_sysvar, Working with System Variables>
*/
...
public:
  ...
  */
  ...
  /** \details
    ...
    <link db_rb, Working with Tagged Data>
  */
  OdResult copyFrom( const OdRxObject* pRb );
...
//  kRtModeless                 = 5027,
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link db_rb_sequence, Sequence of Tagged Data>
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link db_rb_data_string, Getting and Setting Strings>
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link db_rb_data_typical, Getting and Setting Typical Data (integer, double, boolean)>
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link db_rb_data_point, Getting and Setting Points and Vectors>
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link db_rb_data_other, Getting and Setting Specific Data (color, binary, resbuf)>
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link db_rb_data_object, Getting and Setting Objects>
...
protected:
  /** \details
    ...
    See: <link db_rb_sequence, Sequence of Tagged Data>
  */
  OdResBuf();
...
TOOLKIT_EXPORT OdResBufPtr odutDupGcRbChain(const resbuf* pSrc,  OdDbDatabase* pDb = NULL);
