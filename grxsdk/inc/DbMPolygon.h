 ...
 */
  ...
  */
  OdResult setGradientOneColorMode( bool oneColorMode );
 ...
 */
  ...
  */
  ...
  /** \details
    ...
    \returns eOk if reading was successful or an appropriate OdResult error code
    in other case.
  */
...
inline OdDbMpolygonLoops::OdDbMpolygonLoops(int lindex, int gindex, int gcnt)
{
  mLoopIndex = lindex;
  mGripIndex = gindex;
  mGripCount = gcnt;
...
class MPOLYGON_EXPORT OdDbMPolygonCrossing
{
public:
