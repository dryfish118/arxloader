...
public:
  ...
  */
  virtual OdGsDevice* getDevice() const;
  ...
  */
  virtual const OdGsClientViewInfo& getClientViewInfo() const;
  ...
  */
  virtual void freezeLayer(OdLongPtr layerID);
  ...
  /** \details
    ...
    <link tv_working_with_attributes_layers, Working with Layers>
  */
  virtual void thawLayer(OdLongPtr layerID);
  ...
  */
  virtual void setViewportBorderProperties(const OdGsColor& color, int width);
  ...
  */
  virtual void getViewportBorderProperties(OdGsColor& color, int& width) const;
  ...
  */
  virtual OdGsView* clone(bool cloneViewParameters = true, bool cloneGeometry = false);
  ...
  */
  ...
  virtual void setLineweightToPixScale(int lwScale);
  /** \details
  ...
  */
  virtual bool pointInView(const OdGePoint3d &pt);
  ...
  /** \details
    ...
    \param maxPt [in]  maximal WCS box point.
  */
  virtual bool extentsInView(const OdGePoint3d &minPt, const OdGePoint3d &maxPt);
  ...
  */
  virtual bool isPointInViewport(const OdInt32 x, const OdInt32 y);  
  ...
  */
  virtual OdGsModel *getModel(OdGiDrawable *pDrawable) const;
  
  /** \details
    Returns array of OdGsModel objects associated with this Viewport object.
  */
  virtual void getModelList(OdArray<OdGsModel*> &p) const;
  ...
  */
  virtual void setBackground(const OdDbObjectId backgroundId);
  ...
  /** \details
    ...
    <link tv_working_with_attributes_view_backgrounds, Working with View Backgrounds>
  */
  virtual OdDbObjectId background() const;
  ...
  */
  ...
  virtual void setVisualStyle2(const OdDbObjectId visualStyleId);
  /** \details
    Returns current visual style object ID for this view.
    \sa
    <link tv_working_with_attributes_visual_styles, Working with Visual Styles>
  */
  virtual OdDbObjectId visualStyle() const;
  virtual OdDbObjectId visualStyle2() const;
  /** \details
  ...
  */
  bool isValidViewportId(const OdULongPtr vpId) const;

  //NS TODO: rename to viewportObjectId()
  /** \details
    Returns the Object ID of the OdDbViewport object associated with this object.
  */
  OdDbStub* getViewportObjectId() const { return (OdDbStub*)m_viewInfo.viewportObjectId; }
...
protected:
  ...
  mutable OdGsClientViewInfo m_tmpviewInfo;
...
{
  return m_viewInfo.contextColors;
}
