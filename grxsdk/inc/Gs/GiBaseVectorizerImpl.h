...
public:
  ...
  */
  TD_USING(OdGiViewport::getModelToEyeTransform);
  virtual void getModelToEyeTransform(OdGeMatrix3d&) const;
  
  /** \details
    Returns the transformation matrix from EyeSpace to ModelSpace for this object.
  */
  TD_USING(OdGiViewport::getEyeToModelTransform);
  virtual void getEyeToModelTransform(OdGeMatrix3d&) const;
  
  /** \details
    Returns the transformation matrix from WCS to EyeSpace for this object.
  */
  TD_USING(OdGiViewport::getWorldToEyeTransform);
  virtual void getWorldToEyeTransform(OdGeMatrix3d&) const;
  
  /** \details
    Returns the transformation matrix from EyeSpace to WCS for this object.
  */
  TD_USING(OdGiViewport::getEyeToWorldTransform);
  virtual void getEyeToWorldTransform(OdGeMatrix3d&) const;
  ...
  */
  virtual void getCameraLocation(OdGePoint3d&) const;
  
  /** \details
    Returns the WCS camera target for this vectorizer.
  */
  virtual void getCameraTarget(OdGePoint3d&) const;
  
  /** \details
    Returns the WCS camera "up" vector for this vectorizer.
  */
  virtual void getCameraUpVector(OdGeVector3d&) const;
  ...
  */
  virtual OdULongPtr viewportId() const;
  ...
  */
  virtual OdBool pushModelTransform(const OdGeVector3d& normal);
  ...
  */
  virtual OdBool pushModelTransform(const OdGeMatrix3d & xfm);
  ...
  */
  virtual OdBool xline(const OdGePoint3d& firstPoint, const OdGePoint3d& secondPoint) const;
  ...
  /** \details
    ...
    <link tv_geometry_lines.html, Working with Lines>
  */
  virtual OdBool ray(const OdGePoint3d& basePoint, const OdGePoint3d& throughPoint) const;
  ...
  */
  virtual void setExtents(OdGePoint3d *newExtents) const;
  ...
  */
  virtual bool isValidId(const OdULongPtr viewportId) const;
  
  /** \details
    Returns the Object ID of the OdDbViewport object associated with this object.
  */
  virtual OdDbObjectId viewportObjectId() const;
