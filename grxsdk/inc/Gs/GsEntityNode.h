...
public:
  ...
  */
  ...
  protected:
    ...
    OdUInt64 m_nLength;
  public:
    class GS_TOOLKIT_EXPORT OdGsDeviceSelfReference : public OdRxObject, public OdHeapOperators
    {
...
public:
  ...
  */
  ...
  virtual bool hasDataToPlayAsGeometry(OdGsBaseVectorizer& view, EMetafilePlayMode eMode);
  /** \details
  ...
  */
  ...
  virtual bool realExtents(const OdGsView* pView, OdGeExtents3d& ext) const;
public:
...
{
  if (GETBIT(m_flags, kMultilistNextPtr))
    return NULL;// throw OdError(eInvalidIndex);
