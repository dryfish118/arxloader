...
class OdGiLayerTraitsTakerView : public OdGiLayerTraitsTaker, public OdGiViewport
{
  ...
  public:
    ...
    */
    bool isValidId(const OdULongPtr acgiId) const { return m_view.isValidViewportId(acgiId); }
    ...
    */
    OdDbObjectId viewportObjectId() const { return m_view.getViewportObjectId(); }
    ...
    */
    virtual void getModelToEyeTransform(OdGeMatrix3d& trans) const { getWorldToEyeTransform(trans); }
    ...
    /** \details
      ...
      <link CoordinateSystems, Coordinate Systems>
    */
    virtual void getEyeToModelTransform(OdGeMatrix3d& trans) const { getEyeToWorldTransform(trans); }
    ...
    /** \details
      ...
      <link CoordinateSystems, Coordinate Systems>
    */
    virtual void getWorldToEyeTransform(OdGeMatrix3d& trans) const { trans = m_view.worldToEyeMatrix(); }
    ...
    /** \details
      ...
      <link CoordinateSystems, Coordinate Systems>
    */
    virtual void getEyeToWorldTransform(OdGeMatrix3d& trans) const { trans = m_view.eyeToWorldMatrix(); }
    ...
    */
    virtual void getCameraLocation(OdGePoint3d& pt) const { pt = m_view.position(); }
    
    /** \details
      Returns the WCS camera target for this Viewport object.
    */
    virtual void getCameraTarget(OdGePoint3d& pt) const { pt = m_view.target(); }
    
    /** \details
      Returns the WCS camera "up" vector for this Viewport object.
    */
    virtual void getCameraUpVector(OdGeVector3d& vec) const { vec = m_view.upVector(); }
    ...
    */
    virtual OdULongPtr viewportId() const { return m_view.viewportId(); }
    ...
    */
    ...
    { OdGsClientViewInfo vi = m_view.getClientViewInfo();
    ...
    */
    virtual bool layerVisible(const OdDbObjectId& layerId) const { return m_view.isLayerVisible(layerId); }
    ...
    */
    virtual OdBool regenAbort() const { return m_view.userGiContext()->regenAbort(); }
    
    /** \details
      Retrieves pointer to a context associated with this object.
    */
    virtual OdGiContext* context() { return m_view.userGiContext(); }
  protected:
    OdGsViewImpl& m_view;
};
