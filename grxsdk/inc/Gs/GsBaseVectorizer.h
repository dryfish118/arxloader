...
public:  
  ...
  */
  virtual OdBool draw(OdGiDrawable* pDrawable) const { draw(pDrawable); return kTrue; };
#endif
  /** \details
  ...
  */
  ...
  /** \details
    ...
    \remarks
    This method takes effect only if the passed flags parameter has the
    kSharedRefUpdate flag set to true.
  */
  ...
  */
  virtual OdBool regenAbort() const;
  ...
  */
  virtual void setSelectionMarker(const OdLongPtr selectionMarker);
  ...
  */
  virtual void highlight(bool bHighlight, OdUInt32 nSelStyle = 0);
...
protected:
  ...
  */
  ...
  virtual void displayNode(OdGsNode* pNode, bool bUpdate);
  /** \details
...
inline void OdGsBaseVectorizer::setFaded(bool bOn, OdUInt32 whichFade)
{
}
