...
class OdGsViewWrapper : public RedirectionBase
{
  ...
  public:
    ...
    */
    OdGsDevice* getDevice() const
    {
      if (trHas())
        return trCall()->getDevice();
      return NULL;
    }
    ...
    */
    OdGsModel *getModel(OdGiDrawable *pDrawable) const
    {
      if (trHas())
    ...
    */
    void getModelList(OdArray<OdGsModel*> &p) const
    {
      if (trHas())      
        trCall()->getModelList(p);      
    }
   ...
   */
    ...
    */
    void freezeLayer(OdLongPtr layerID)
    {
      if (trHas())
    ...
    /** \details
      ...
      <link tv_working_with_attributes_layers, Working with Layers>
    */
    void thawLayer(OdLongPtr layerID)
    {
      if (trHas())
    ...
    */
    bool pointInView(const OdGePoint3d &pt)
    {
      if (trHas())
    ...
    */
    bool extentsInView(const OdGePoint3d &minPt, const OdGePoint3d &maxPt)
    {
      if (trHas())
    ...
    */
    OdGsView* clone(bool cloneViewParameters = true, bool cloneGeometry = false)
    {
      if (trHas())
        return trCall()->clone(cloneViewParameters, cloneGeometry);
      return NULL;
    }
    ...
    */
    bool isPointInViewport(const OdInt32 x, const OdInt32 y)
    {
      if (trHas())
        return trCall()->isPointInViewport(x, y);
      return false;
    }
...
class OdGsDeviceWrapper : public RedirectionBase
{
  ...
  public:
    ...
    */
    bool add(OdGsView* pView)
    {
      if (trHas())
        return trCall()->add(pView);
    ...
    */
    ...
    /** \details
      ...
      This method returns false if there is no redirection device.
    */
    bool erase(OdGsView* pView)
    {
      if (trHas())
        return trCall()->erase(pView);
      return false;
    }
    ...
    */
    ...
    /** \details
      ...
      This method returns false if there is no redirection device.
    */
    bool setBackgroundColor(OdGsColor backgroundColor)
    {
      if (trHas())
    ...
    */
    OdGsColor getBackgroundColor()
    {
      if (trHas())
        return trCall()->getBackgroundColor();

      OdGsColor clr;
      clr.setCOLORREF(RGB(0, 0, 0));
      return clr;
    }
    ...
    */
    ...
    void setLogicalPalette(const OdGsColor* logicalPalette, int numColors)
    {
      if (trHas())
        trCall()->setLogicalPalette(logicalPalette, numColors);
    }

    void setPhysicalPalette(const OdGsColor* logicalPalette, int numColors)
    {
      if (trHas())
        trCall()->setPhysicalPalette(logicalPalette, numColors);
    }
...
class OdGsViewWrapperMinimalImpl : public OdGsViewWrapper<GsViewInterface, RedirectionBase>
{
  ...
  public:
    ...
    */
    OdGsDevice* getDevice() const { return m_pDevice; }
    ...
    */
    void setViewportBorderProperties(const OdGsColor& color, int width)
    { m_borderColor = color.asCOLORREF(); m_borderWidth = width; }
    ...
    */
    ...
    /** \details
      ...
      \param clientViewInfo [out]  Receives the ClientViewInfo.
    */
    virtual const OdGsClientViewInfo& getClientViewInfo() const { return m_viewInfo; }    
    ...
    */
    ...
    /** \details
      ...
      <link tv_working_with_attributes_view_backgrounds, Working with View Backgrounds>
    */
    void setBackground(const OdDbObjectId backgroundId) { m_bkgnd = backgroundId; }
    ...
    /** \details
      ...
      <link tv_working_with_attributes_view_backgrounds, Working with View Backgrounds>
    */
    OdDbObjectId background() const { return m_bkgnd; }
    ...
    /** \details
      ...
      <link tv_working_with_attributes_visual_styles, Working with Visual Styles>
    */
    void setVisualStyle(const OdDbObjectId visualStyleId) { m_visualStyle = visualStyleId; }
    ...
    /** \details
      ...
      <link tv_working_with_attributes_visual_styles, Working with Visual Styles>
    */
    OdDbObjectId visualStyle() const { return m_visualStyle; }
  ...
  public:
    ...
    */
    ...
    /** \details
      ...
      pViewInfo contains information returned by OdGiViewport::acadWindowId() and OdGiViewportDraw::viewportObjectId()
    */
    bool add(OdGsView* pView) { m_views.push_back(pView); return true; }
    ...
    */
    bool erase(OdGsView* pView) { m_views.remove(pView); return true; }
    ...
    /** \details
      ...
      Returns true if and only if successful.
    */
    bool erase(int viewIndex) { m_views.removeAt(viewIndex); return true; }
    
    /** \details
      Erases all views associated with this Device object.
    */
    void eraseAll() { m_views.clear(); }
    ...
    */
    ...
    /** \details
      ...
      true.
    */
    bool setBackgroundColor(OdGsColor backgroundColor) { m_backColor = backgroundColor.asCOLORREF(); return true; }
    
    /** \details
      Returns the Background Color of the GUI window of this Device object.
    */
    OdGsColor getBackgroundColor() { return m_backColor; }
