...
public:
  ...
  */
  ...
  void onAdded(OdGiDrawable* pAdded, OdIntDbId parentID);
  ...
  void onModified(OdGiDrawable* pModified, OdIntDbId parentID);
  ...
  void onErased(OdGiDrawable* pErased, OdIntDbId parentID);
  ...
  void onUnerased(OdGiDrawable* pUnerased, OdIntDbId parentID);
  ...
  */
  ...
  void highlight(OdGsCache* pGsNode, const OdGiPathNode& path, bool bDoIt, const OdGsView* pView = 0);
  ...
  */
  ...
  /** \details
    ...
    <link tv_working_with_attributes_visual_styles, Working with Visual Styles>
  */
  void setSectioningVisualStyle(const OdDbObjectId visualStyleId);
...
public:
  ...
  void removeLayer(OdGsNode* pNode);
};
...
inline OdGsModel::RenderType OdGsBaseModel::renderType()
{
  return m_renderType;
}
