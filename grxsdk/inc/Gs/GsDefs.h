...
struct OdGsColor
{
  ...
  OdGsColor(unsigned char red, unsigned char green, unsigned char blue, unsigned char filler)
    : m_red(red), m_green(green), m_blue(blue), m_filler(filler)
  {
  }

  OdGsColor()
  {
    setCOLORREF(RGB(0,0,0));
  }

  OdGsColor(COLORREF clr)
  {
    setCOLORREF(clr);
  }
