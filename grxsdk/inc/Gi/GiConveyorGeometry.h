...
public:
  ...
  */
  ...
  virtual OdGiDrawableTraits& drawableTraits() const = 0;
...
public:
  ...
  */
  ...
  OdGiDrawableTraits& drawableTraits() const { return m_pCtx->drawableTraits(); }
...
#pragma warning (pop)
  ...
  */
  ...
  virtual void polylineExProc(OdInt32 nbPoints, const OdGePoint3d* pVertexList,
    const OdGeVector3d* pNormal = 0,
    const OdGeVector3d* pExtrusion = 0,
