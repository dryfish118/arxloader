...
class ODGI_EXPORT OdGiRasterImageLoaderPE : public OdRxObject
{
  public:
    ...
    */
    virtual OdGiRasterImagePtr loadRasterImage(const OdString &fileName, OdDbDatabase* pDb, OdDbBaseHostAppServices::FindFileHint hint = OdDbBaseHostAppServices::kDefault) = 0;
};
