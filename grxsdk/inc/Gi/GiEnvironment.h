...
/** \details
    ...
    <group OdGi_Classes> 
*/
class ODRX_ABSTRACT FIRSTDLL_EXPORT OdGiRenderEnvironmentTraits : public OdGiNonEntityTraits
{
public:
...
/** \details
    ...
    <group OdGi_Classes> 
*/
class ODRX_ABSTRACT FIRSTDLL_EXPORT OdGiRenderSettingsTraits : public OdGiNonEntityTraits
{
public:
...
public:
  ...
  */
  virtual void setExportMIFileName(const OdChar* miName) = 0;
  ...
  */
  virtual const OdChar* exportMIFileName() const = 0;
...
/** \details
    ...
    <group OdGi_Classes> 
*/
class ODRX_ABSTRACT FIRSTDLL_EXPORT OdGiSolidBackgroundTraits : public OdGiNonEntityTraits
{
public:
...
/** \details
    ...
    <group OdGi_Classes> 
*/
class ODRX_ABSTRACT FIRSTDLL_EXPORT OdGiGradientBackgroundTraits : public OdGiNonEntityTraits
{
public:
...
/** \details
    ...
    <group OdGi_Classes> 
*/
class ODRX_ABSTRACT FIRSTDLL_EXPORT OdGiImageBackgroundTraits : public OdGiNonEntityTraits
{
public:
  ...
  */
  virtual void setImageFilename(const OdChar* filename) = 0;
  ...
  */
  virtual const OdChar * imageFilename(void) const = 0;
...
/** \details
    ...
    <group OdGi_Classes> 
*/
class ODRX_ABSTRACT FIRSTDLL_EXPORT OdGiGroundPlaneBackgroundTraits : public OdGiNonEntityTraits
{
public:
...
/** \details
    ...
    <group OdGi_Classes> 
*/
class ODRX_ABSTRACT FIRSTDLL_EXPORT OdGiSkyBackgroundTraits : public OdGiNonEntityTraits
{
public:
...
/** \details
    ...
    <group OdGi_Classes>
*/
class ODRX_ABSTRACT FIRSTDLL_EXPORT OdGiIBLBackgroundTraits : public OdGiNonEntityTraits
{
public:
  ...
  */
  ...
  /** \details
    ...
    full path to an image file.
  */
  virtual OdString IBLImageName() const = 0;
  ...
  */
  virtual void setSecondaryBackground(const OdDbObjectId bg) = 0;
  ...
  */
  virtual OdDbObjectId secondaryBackground() const = 0;
};
