...
public:
  ...
  */
  static OdGiRasterImagePtr createObject(OdUInt32 pixelWidth, OdUInt32 pixelHeight, OdUInt8 units = 0, double xPelsPerUnit = 0.0, double yPelsPerUnit = 0.0);
  ...
  /** \details
    ...
    Returns a SmartPointer to the newly created object.
  */
  static OdGiRasterImagePtr createObject(OdUInt32 pixelWidth, OdUInt32 pixelHeight, OdUInt32 colorDepth, OdUInt8 units = 0, double xPelsPerUnit = 0.0, double yPelsPerUnit = 0.0);
  ...
  */
  OdUInt8 defaultResolution(double& xPelsPerUnit, double& yPelsPerUnit) const;
  ...
  */
  ...
  /** \details
    ...
    \param yPelsPerUnit [in]  Pixels per unit value (y direction).
  */
  void setDefaultResolution(OdUInt8 units, double xPelsPerUnit, double yPelsPerUnit);
  /** \details
