...
class ODGI_EXPORT OdGiClippedGeometryOutput : public OdRxObject, public OdGiConveyorPassingImpl<OdGiClippedGeometryOutput>
{
    ...
    */
    virtual void setupTraits(OdGiConveyorContext &context)
    {
      if (m_overrideFlags)
      {
        ...
        OdGiSubEntityTraitsToData::copyTraits(context.drawableTraits(), dataAdaptor, m_overrideFlags);
        // Setup traits overrides
        dataAdaptor.setTraits(m_overrides);
        OdGiSubEntityTraitsToData::copyTraits(dataAdaptor, context.drawableTraits(), m_overrideFlags);
  ...
  */
    ...
    */
    void nurbsProc(const OdGeNurbCurve3d& nurbsCurve, const OdGeVector3d* pNormal = 0)
    { WrapTraitsProc _wtp(this);
      destGeometry().nurbsProc(nurbsCurve, pNormal);
    }
...
class ODGI_EXPORT OdGiSectionGeometryOutput : public OdGiClippedGeometryOutput
{
  ...
  public:
    ...
    */
    virtual OdResult copyFrom(const OdRxObject* pSource)
    {
      const OdGiSectionGeometryOutput *pFrom = OdGiSectionGeometryOutput::ODSYSCALL1(cast, pSource);
      if (!pFrom)
        return eInvalidInput;
...
class ODGI_EXPORT OdGiCuttedGeometryOutput : public OdGiClippedGeometryOutput
{
  public:
    ...
    */
    virtual OdResult copyFrom(const OdRxObject* pSource)
    {
      const OdGiCuttedGeometryOutput *pFrom = OdGiCuttedGeometryOutput::ODSYSCALL1(cast, pSource);
      if (!pFrom)
        return eInvalidInput;
      return OdGiClippedGeometryOutput::copyFrom(pSource);
    }
};
