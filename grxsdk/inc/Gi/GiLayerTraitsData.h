...
/** \details
    ...
    <group OdGi_Classes>
*/
class OdGiSubEntityTraits_ : public OdGiDummySubEntityTraits< OdGiDrawableTraits >
{  
};
...
struct OdGiLayerTraitsData
{
  ...
  */
  OdDbObjectId linetypeId() const { return m_linetypeId; }
  
  /** \details
    Retrieves plot style name type of this layer.
  */
  OdDb::PlotStyleNameType getPlotStyleNameId(OdDbObjectId& id) const { id = m_plotStyleNameId; return m_plotStyleNameType; }
  ...
  */
  OdDbObjectId materialId() const { return m_materialId; }
...
public:
  ...
  */
  ...
  /** \details
    ...
    <exref target="https://docs.opendesign.com/td/db_linetype.html">Working with Linetypes</exref>
  */
  void setLinetype(const OdDbObjectId pLinetypeId);
