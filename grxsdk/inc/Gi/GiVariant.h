...
class FIRSTDLL_EXPORT OdGiVariant : public OdRxObject
{
  ...
  public:
    ...
    OdGiVariant(const OdCmColor& value);
  ...
  public:
    ...
    */
    virtual bool operator ==(const OdGiVariant& value) const;
    ...
    */
    ...
    void set(const OdCmColor &value);
    ...
    */
    ...
    OdResult getElem(const OdChar* pKey, OdGiVariant &value) const;
    ...
    */
    ...
    OdResult getElemAt(int nIndex, OdChar*&, OdGiVariant &) const;
    ...
    */
    ...
    OdGiVariant* getElemAt(int nIndex, OdChar*&) const;
