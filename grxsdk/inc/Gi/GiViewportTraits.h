...
public:
  ...
  */
  virtual void setWhiteColor(const OdCmColor &color);
  
  /** \details
    Retrieves the reference white color.
  */
  virtual OdCmColor whiteColor() const;
...
*/
class FIRSTDLL_EXPORT OdGiViewportTraits : public OdGiDrawableTraits
{
public:
  ...
  */
  virtual void setAmbientLightColor(const OdCmColor& color) = 0;  
  /** \details
    Retrieves the ambient color (color in the shadows).
  */
  virtual OdCmColor ambientLightColor() const = 0;
  ...
  */
  virtual void setBackground(const OdDbObjectId bg) = 0;
  /** \details
  ...
  */
  virtual void setRenderEnvironment(const OdDbObjectId re) = 0;
  /** \details
    Retrieves a pointer to the render environment for this viewport. Used only in full renders.
  */
  virtual OdDbObjectId renderEnvironment () const = 0;
  ...
  */
  virtual void setRenderSettings(const OdDbObjectId rs) = 0;
  /** \details
    Retrieves a pointer to the render settings for this viewport. Used only in full renders.
  */
  virtual OdDbObjectId renderSettings() const = 0;
  ...
  */
  virtual void toneOperatorParameters(OdGiToneOperatorParameters &params) const = 0;
};

class OdGiViewportTraits;
class OdCmEntityColor;
ODGI_EXPORT void odgsSetTraitAmbientLightColor(OdGiViewportTraits* pTrait, const OdCmEntityColor& clr);
