...
public:
  ...
  */
  ...
  <link tv_geometry_polygons, Working with Polygons>
  */
  virtual OdBool polygon(OdInt32 nbPoints, const OdGePoint3d* pVertexList, const OdGeVector3d* pNormal)
  {
    return m_Geom->polygon(nbPoints, pVertexList, pNormal);
  }
  ...
  */
  virtual OdBool shell(const OdUInt32 nbVertex,
    ...
    const struct resbuf* pResBuf = NULL,const bool bAutoGenerateNormals = true) const
  {
  ...
  */
  virtual OdBool image(const OdGiImageBGRA32& img,
                     const OdGePoint3d& origin,
                     const OdGeVector3d& uVec,
                     const OdGeVector3d& vVec,
                     OdGiGeometry::TransparencyMode trpMode = OdGiGeometry::kTransparency8Bit) const
  {
    return m_Geom->image(img, origin, uVec, vVec, trpMode);
  }
  ...
  */
  ...
  {
    return m_Geom->polyPolygon(numIndices, pNumPositions, pPositions, pNumPoints, pPoints,
  ...
  */
  virtual OdBool polypoint(OdInt32 numPoints, const OdGePoint3d* vertexList, const OdCmEntityColor* pColors, const OdCmTransparency* pTransparency,
                         const OdGeVector3d* pNormals, const OdLongPtr* pSubEntMarkers, OdInt32 nPointSize)
  {
  ...
  */
  virtual OdBool rowOfDots(int numPoints, const OdGePoint3d& startPoint, const OdGeVector3d& dirToNextPoint) const
  {
    return m_Geom->rowOfDots(numPoints, startPoint, dirToNextPoint);
  }
...
public:
  /** \details
    ...
    \param vertexList        [in]  Pointer to an array of vertices.
  */
  virtual OdBool polylineEye(
    const OdUInt32 numVertices,
    const OdGePoint3d* vertexList) const { ((OdGiViewportGeometry&)(OdGiWrapperGeometry< T >::getGeom())).polylineEye(numVertices, vertexList); return kTrue; }
  ...
  /** \details
    ...
    \param vertexList        [in]  Pointer to an array of vertices.
  */
  virtual OdBool polygonEye(
    const OdUInt32 numVertices,
    const OdGePoint3d* vertexList) const { ((OdGiViewportGeometry&)(OdGiWrapperGeometry< T >::getGeom())).polygonEye(numVertices, vertexList); return kTrue; }
  ...
  /** \details
    ...
    \param vertexList        [in]  Pointer to an array of vertices.
  */
  virtual OdBool polylineDc(
    const OdUInt32 numVertices,
    const OdGePoint3d* vertexList) const { ((OdGiViewportGeometry&)(OdGiWrapperGeometry< T >::getGeom())).polylineDc(numVertices, vertexList); return kTrue; }
  ...
  /** \details
    ...
    \param vertexList        [in]  Pointer to an array of vertices.
  */
  virtual OdBool polygonDc(
    const OdUInt32 numVertices,
    const OdGePoint3d* vertexList) const { ((OdGiViewportGeometry&)(OdGiWrapperGeometry< T >::getGeom())).polygonDc(numVertices, vertexList); return kTrue; }
...
class OdGiSubEntityTraitsToDataWrapper : public TInterface
{
  ...
  public:
    ...
    */
    void setLayer(const OdDbObjectId n) { m_pTraits->setLayer(n); }
    ...
    */
    void setLineType(const OdDbObjectId n) { m_pTraits->setLineType(n); }
    
    /** \details
      Sets the current selection marker.
    */
    void setSelectionMarker(const OdLongPtr /*n*/) { } // Stub
    ...
    */
    void setPlotStyleName(OdDb::PlotStyleNameType n, const OdDbObjectId m = 0) { m_pTraits->setPlotStyleName(n, m); }
    ...
    */
    void setMaterial(const OdDbObjectId n) { m_pTraits->setMaterial(n); }
    ...
    */
    void setVisualStyle(const OdDbObjectId n) { m_pTraits->setVisualStyle(n); }
    ...
    */
    OdResult setDrawFlags(OdUInt32 drawFlags) { return m_pTraits->setDrawFlags(drawFlags); }
    ...
    */
    OdResult setShadowFlags(OdGiSubEntityTraits::ShadowFlags shadowFlags) { return m_pTraits->setShadowFlags(shadowFlags); }
    ...
    */
    OdResult setSelectionFlags(const OdGiSubEntityTraits::SelectionFlags selectionFlags) {return m_pTraits->setSelectionFlags(selectionFlags);}
    ...
    */
    ...
    /** \details
      ...
      <link tv_working_with_attributes_layers, Working with Layers>
    */
    OdDbObjectId layerId() const { return m_pTraits->layerId(); }
    ...
    <exref target="https://docs.opendesign.com/td/db_linetype.html">Working with Linetypes</exref>
    */
    OdDbObjectId lineTypeId() const { return m_pTraits->lineTypeId(); }
    ...
    */
    ...
    OdDb::PlotStyleNameType getPlotStyleNameId(OdDbObjectId& id) const { return m_pTraits->getPlotStyleNameId(id); }
    ...
    /** \details
      ...
      <link tv_working_with_attributes_materials, Working with Materials>
    */
    OdDbObjectId materialId() const { return m_pTraits->materialId(); }
    ...
    */
    ...
    /** \details
      ...
      <link tv_working_with_attributes_visual_styles, Working with Visual Styles>
    */
    OdDbObjectId visualStyle() const { return m_pTraits->visualStyle(); }
...
<group OdGi_Classes>
*/
class OdGiSubEntityTraitsToData : public OdGiSubEntityTraitsToDataWrapper<OdStaticRxObject<OdGiDrawableTraits>, OdGiSubEntityTraitsData>
                                , public OdGiSubEntityTraitsChangedFlags
{
  public:
    ...
    */
    static void copyTraits(OdGiDrawableTraits &pFrom, OdGiDrawableTraits &pTo, OdUInt32 nFlags = kAllChanged)
    {
      if (GETBIT(nFlags, kColorChanged)) pTo.setTrueColor(pFrom.trueColor());
      if (GETBIT(nFlags, kLayerChanged)) pTo.setLayer(pFrom.layerId());
      if (GETBIT(nFlags, kLineTypeChanged)) pTo.setLineType(pFrom.lineTypeId());
      ...
      if (GETBIT(nFlags, kPlotStyleChanged))
      {
        OdDbObjectId plotId;
        OdDb::PlotStyleNameType sType = pFrom.getPlotStyleNameId(plotId);
        pTo.setPlotStyleName(sType, plotId);
      }
      if (GETBIT(nFlags, kMaterialChanged)) pTo.setMaterial(pFrom.materialId());
...
public:
  ...
  */
  void setSelectionMarker(const OdLongPtr n) { baseTraits()->setSelectionMarker(n); }
...
public:
  ...
  */
  virtual bool isValidId(const OdULongPtr viewportId) const { return ((OdGiViewportDraw*)(OdGiWrapperCommonDraw< T >::getDraw()))->isValidId(viewportId); }
  ...
  */
  virtual OdDbObjectId viewportObjectId() const { return ((OdGiViewportDraw*)(OdGiWrapperCommonDraw< T >::getDraw()))->viewportObjectId(); }
};
...
class OdGiViewportDraw_Stub : public OdGiWrapperViewportDraw<OdGiViewportDraw>
                            ...
                            , public OdGiSubEntityTraitsWrapper<OdGiDrawableTraits>
{
public:
...
public:
  ...
  */
  ...
  <link tv_geometry_polygons, Working with Polygons>
  */
  OdBool polygon(OdInt32 numVertices, const OdGePoint3d* vertexList, const OdGeVector3d* pNormal) {return ::kFalse;}
  ...
  */
  ...
  /** \details
    ...
    <link tv_geometry_raster_images, Working with Raster Image Geometry Data>
  */
  OdBool image(const OdGiImageBGRA32& img,
    const OdGePoint3d& origin,
    const OdGeVector3d& uVec,
    const OdGeVector3d& vVec,
    OdGiRasterImage::TransparencyMode trpMode = OdGiRasterImage::kTransparency8Bit) {return ::kFalse;}
  ...
  */
  OdBool polypoint(OdInt32 numPoints, const OdGePoint3d* vertexList, const OdCmEntityColor* pColors, const OdCmTransparency* pTransparency,
                 const OdGeVector3d* pNormals, const OdLongPtr* pSubEntMarkers, OdInt32 nPointSize) {return ::kFalse;  }
  ...
  /** \details
    ...
    \param dirToNextPoint [in]  Offset to next point.
  */
  OdBool rowOfDots(int numPoints, const OdGePoint3d& startPoint, const OdGeVector3d& dirToNextPoint) const { return ::kFalse; }
...
public:
  ...
  */
  virtual OdBool polylineEye(
    const OdUInt32 numVertices,
    const OdGePoint3d* vertexList) const { return kTrue; }
...
public:
  ...
  */
  ...
  /** \details
    ...
    <link tv_working_with_attributes_layers, Working with Layers>
  */
  void setLayer(const OdDbObjectId layerId) { }
  ...
  */
  ...
  /** \details
    ...
    <link tv_working_with_attributes_materials, Working with Materials>
  */
  void setMaterial(const OdDbObjectId materialId) { }
  ...
  */
  ...
  /** \details
    ...
    <link tv_working_with_attributes_visual_styles, Working with Visual Styles>
  */
  void setVisualStyle(const OdDbObjectId visualStyleId) { }
  ...
  */
  ...
  /** \details
    ...
    \param drawFlags [in]  Input bitmask with DrawFlags.
  */
  OdResult setDrawFlags(OdUInt32 drawFlags) { return Oda::eOk; }
  ...
  */
  ...
  /** \details
    ...
    <link gi_shadows_rendering, Shadows Visualization>
  */
  OdResult setShadowFlags(OdGiSubEntityTraits::ShadowFlags shadowFlags) { return Oda::eOk; }
  ...
  */
  ...
  /** \details
    ...
    \param selectionFlags [in]  Input SelectionFlags.
  */
  OdResult setSelectionFlags(const OdGiSubEntityTraits::SelectionFlags selectionFlags) { return Oda::eOk; }
  ...
  */
  ...
  /** \details
    ...
    <link tv_working_with_attributes_layers, Working with Layers>
  */
  OdDbObjectId layerId() const { return NULL; }
  ...
  /** \details
    ...
    <exref target="https://docs.opendesign.com/td/db_linetype.html">Working with Linetypes</exref>
  */
  OdDbObjectId lineTypeId() const { return NULL; }
  ...
  */
  OdDb::PlotStyleNameType getPlotStyleNameId(OdDbObjectId& id) const { id = NULL; return OdDb::kPlotStyleNameByBlock; }
  ...
  /** \details
    ...
    <link tv_working_with_attributes_materials, Working with Materials>
  */
  OdDbObjectId materialId() const { return NULL; }
...
public:
  /** \details
    ...
    identity matrix in current implementation.
  */
  TD_USING(T::getModelToEyeTransform);
  ...
  /** \details
    ...
    identity matrix in current implementation.
  */
  TD_USING(T::getEyeToModelTransform);
  ...
  /** \details
    ...
    identity matrix in current implementation.
  */
  TD_USING(T::getWorldToEyeTransform);
  ...
  /** \details
    ...
    identity matrix in current implementation.
  */
  TD_USING(T::getEyeToWorldTransform);
  ...
  */
  TD_USING(T::getCameraLocation);
  virtual void getCameraLocation(OdGePoint3d& pt) const { pt = OdGePoint3d::kOrigin; }
  ...
  */
  TD_USING(T::getCameraTarget);
  virtual void getCameraTarget(OdGePoint3d& pt) const { pt = OdGePoint3d::kOrigin + OdGeVector3d::kZAxis; }
  ...
  */
  TD_USING(T::getCameraUpVector);
  virtual void getCameraUpVector(OdGeVector3d& vec) const { vec = OdGeVector3d::kYAxis; }
  ...
  */
  virtual OdULongPtr viewportId() const { return 0xFFFFFFFF; }
  ...
  */
  virtual bool layerVisible(const OdDbObjectId& idLayer) const { return true; }
};
...
public:
  ...
  */
  virtual void getModelToEyeTransform(OdGeMatrix3d& trans) const { get().getModelToEyeTransform(trans); }
  ...
  */
  virtual void getEyeToModelTransform(OdGeMatrix3d& trans) const { get().getEyeToModelTransform(trans); }
  ...
  */
  virtual void getWorldToEyeTransform(OdGeMatrix3d& trans) const { get().getWorldToEyeTransform(trans); }
  ...
  */
  virtual void getEyeToWorldTransform(OdGeMatrix3d& trans) const { get().getEyeToWorldTransform(trans); }
  ...
  */
  virtual void getCameraLocation(OdGePoint3d& pt) const { get().getCameraLocation(pt); }
  ...
  */
  virtual void getCameraTarget(OdGePoint3d& pt) const { get().getCameraTarget(pt); }
  ...
  */
  virtual void getCameraUpVector(OdGeVector3d& vec) const { get().getCameraUpVector(vec); }
  ...
  */
  virtual OdULongPtr viewportId() const { return get().viewportId(); }
  ...
  */
  virtual bool layerVisible(const OdDbObjectId& idLayer) const { return get().layerVisible(idLayer); }
};
...
public:
  ...
  */
  ...
  /** \details
    ...
    true if this vectorization process should be aborted, false otherwise.
  */
  virtual OdBool regenAbort() const                      { return T1::regenAbort(); }
  ...
  */
  ...
  /** \details
    ...
    true if vectorization process is the result of a "drag" operation, false otherwise.
  */
  virtual OdBool isDragging() const                      { return T1::isDragging(); }
  ...
  /** \details
    ...
    Pointer to the associated context.
  */
  virtual OdGiContext* context()                 { return T1::context(); }
...
public:
  ...
  */
  ...
  /** \details
    ...
    false in current implementation.
  */
  virtual OdBool regenAbort() const                      { return false; }
  ...
  /** \details
    ...
    false in current implementation.
  */
  virtual OdBool isDragging() const                      { return false; }
...
public:
  ...
  */
  ...
  /** \details
      ...
      false in current implementation.
  */
  virtual bool isValidId(const OdULongPtr viewportId) const { return false; }
  ...
  0 in current implementation.
  */
  virtual OdDbObjectId viewportObjectId() const { return OdDbObjectId(); }
};
...
public:
  ...
  */
  ...
  /** \details
    ...
    Pointer to the associated context.
  */
  virtual OdGiContext* context()            { return static_cast<OdGiContext*>(const_cast<OdGiViewportDraw_Dummy*>(this)); }
...
<group OdGi_Classes>
*/
class OdGiWorldDraw_Dummy : public OdGiDummySubEntityTraits< OdGiDrawableTraits >
  ...
  , public OdGiDummyContext< OdGiContext >
{
  OdDbDatabase *m_pDb;
public:
  ODRX_USING_HEAP_OPERATORS( OdGiDummySubEntityTraits< OdGiDrawableTraits > );
