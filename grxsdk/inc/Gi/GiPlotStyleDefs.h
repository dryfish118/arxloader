...
class ODGI_EXPORT OdGiPsLinetypes
{
  ...
  protected:
    ...
    OdArray<OdGiLinetypeDef>      m_giLinetypeDefs;
  ...
  public:
    ...
    */
    ...
    /** \details
      ...
      \returns
      reference to an array of OdGiLinetypeDef objects.
    */
    const OdArray<OdGiLinetypeDef> &getGiDefinitions() const;
    /** \details
    ...
    */
    const OdGiLinetypeDef &getGiDefinition(OdPs::LineType psLtp) const;
