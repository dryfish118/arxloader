...
struct OdGiSubEntityTraitsDataSaver : public OdGiSubEntityTraitsData
{
  ...
  */
  void setFill(const OdGiFill* pFill)
  {
    ...
    if (pFill) OdGiSubEntityTraitsData::setFill(static_cast<OdGiFill*>(pFill->ODSYSCALL0(clone).detach()));
...
protected:
  ...
  void allocPtrs()
  {
    ...
    if (fill()) OdGiSubEntityTraitsData::setFill(static_cast<OdGiFill*>(fill()->ODSYSCALL0(clone).detach()));
  }
};
