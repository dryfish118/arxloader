...
public:
  ...
  */
  OdUInt32 getTtfFlags() const  { return m_nFlags & 0x0fffffff;    }
  ...
  */
  ...
  void setDisabledGdi(bool bGdi) { SETBIT(m_nFlags, 0x10000000, bGdi); }
  bool isDisabledGdi() const { return GETBIT(m_nFlags, 0x10000000); }
};
