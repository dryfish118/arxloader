...
public:
  ...
  /** \details
    ...
    Coordinate Systems
  */
  ODRX_SEALED_VIRTUAL  OdGeMatrix3d getModelToEyeTransform() const ;
  ...
  /** \details
    ...
    Coordinate Systems
  */
  ODRX_SEALED_VIRTUAL  OdGeMatrix3d getEyeToModelTransform() const ;
  ...
  /** \details
    ...
    Coordinate Systems
  */
  ODRX_SEALED_VIRTUAL  OdGeMatrix3d getWorldToEyeTransform() const ;
  ...
  /** \details
    ...
    Coordinate Systems
  */
  ODRX_SEALED_VIRTUAL  OdGeMatrix3d getEyeToWorldTransform() const ;
  ...
  */
  virtual OdULongPtr viewportId() const = 0;
  ...
  */
  virtual bool layerVisible(
    const OdDbObjectId& layerId) const = 0;
