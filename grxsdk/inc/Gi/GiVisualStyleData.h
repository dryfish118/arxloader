...
*/
class OdGiVisualStyleDataContainer : public OdStaticRxObject<OdGiImpVisualStyle>
{
  public:
    /** \details
      <group OdGi_Classes>
    ...
    */
    struct OdCmColorBaseAdapt : public OdCmColorBase
    {
      ...
      */
      OdCmEntityColor &entColor() { return const_cast<OdCmEntityColor&>(m_pVar->asEntityColor()); }
      
      /** \details
        Returns the entity color object.
      */
      const OdCmEntityColor &entColor() const { return m_pVar->asEntityColor(); }
      ...
      */
      OdResult setColorMethod(OdCmEntityColor::ColorMethod colorMethod) { return entColor().setColorMethod(colorMethod); }
      ...
      */
      OdResult setColor(OdUInt32 color) { return entColor().setColor(color); }
      ...
      */
      OdResult setRGB(OdUInt8 red, OdUInt8 green, OdUInt8 blue) { return entColor().setRGB(red, green, blue); }
      ...
      /** \details
        ...
        \param red [in]  Red component as an integer value in the range 0 to 255.
      */
      OdResult setRed(OdUInt8 red) { return entColor().setRed(red); }
      ...
      /** \details
        ...
        \param green [in]  Green component as an integer value in the range 0 to 255. 
      */
      OdResult setGreen(OdUInt8 green) { return entColor().setGreen(green); }
      ...
      /** \details
        ...
        \param blue [in]  Blue component as an integer value in the range 0 to 255. 
      */
      OdResult setBlue(OdUInt8 blue) { return entColor().setBlue(blue); }
      ...
      */
      OdResult setColorIndex(OdUInt16 colorIndex) { return entColor().setColorIndex(colorIndex); }

      bool isByPen() const { return entColor().isByPen(); }

      OdUInt16 penIndex() const { return entColor().penIndex(); }

      OdResult setPenIndex(OdUInt16 penIndex) { return entColor().setPenIndex(penIndex); }
      ...
      */
      OdResult setColorMethod(OdCmEntityColor::ColorMethod colorMethod) { return m_entColor.setColorMethod(colorMethod); }
...
#endif
      // Unnecessary methods
      OdResult setNames(const OdChar* /*colorName*/, const OdChar* /*bookName*/ = NULL) { return eOk; }
      const OdChar* colorName() const { return OdString::kEmpty; }
      const OdChar* bookName() const { return OdString::kEmpty; }
      const OdChar* colorNameForDisplay() { return OdString::kEmpty; }
      virtual FIRSTDLL_EXPORT bool hasColorName() const;
      virtual FIRSTDLL_EXPORT bool hasBookName() const;
      //DOM-IGNORE-END
    };
    ...
    */
    class OdGiFaceStyleDataContainer : public OdStaticRxObject<OdGiFaceStyle>
    {
      ...
      public:
        ...
        */
        void setBase(OdGiImpVisualStyle *pBase)
        {
          m_pBase = pBase;
  ...
  public:
    ...
    */
    OdGiVisualStyleDataContainer()
      ...
      , m_edgeStyle()
      , m_displayStyle()
      , m_type(OdGiVisualStyle::kCustom)
    {
      // Setup redirections
