...
public:
  ...
  */
  OdDb::PlotStyleNameType getPlotStyleNameId(OdDbObjectId&) const;
  ...
  */
  void setPlotStyleName(OdDb::PlotStyleNameType plotStyleNameType, const OdDbObjectId pPlotStyleNameId = 0);
  ...
  */
  ...
  /** \details
    ...
    <link tv_working_with_attributes_materials, Working with Materials>
  */
  void setMaterial(const OdDbObjectId pMaterialId);
  ...
  */
  OdResult setDrawFlags(OdUInt32 drawFlags);
  ...
  */
  ...
  /** \details
    ...
    <link gi_shadows_rendering, Shadows Visualization>
  */
  OdResult setShadowFlags(ShadowFlags shadowFlags);
  ...
  */
  OdResult setSelectionFlags(const SelectionFlags selectionFlags);
  ...
  */
  TD_USING(OdGiCommonDraw::rawGeometry);
...
protected:
  ...
  virtual bool layerVisible(const OdDbObjectId& layerId) const;
  /** \details
...
public:
  ...
  */
  ...
  /** \details
    ...
    <link tv_working_with_attributes_visual_styles, Working with Visual Styles>
  */
  void setVisualStyle(const OdDbObjectId pVisualStyleId);
  ...
  */
  OdGiSubEntityTraits& subEntityTraits() const;
  OdGiDrawableTraits& drawableTraits() const;
  ...
  */
  ...
  /** \details
      ...
      false
  */
  bool isValidId(const OdULongPtr viewportId) const;
  ...
  */
  OdDbObjectId viewportObjectId() const;
  ...
  */
  ...
  /** \details
    ...
    <link tv_geometry_polygons, Working with Polygons>
  */
  OdBool polygon(OdInt32 numVertices, const OdGePoint3d* vertexList, const OdGeVector3d* pNormal);
  ...
  */
  OdBool rowOfDots(int numPoints, const OdGePoint3d& startPoint, const OdGeVector3d& dirToNextPoint) const;
  ...
  */
  ...
  /** \details
    ...
    \param vertexList        [in]  Pointer to an array of vertices.
  */
  OdBool polylineEye(const OdUInt32 numVertices, const OdGePoint3d* vertexList) const;
  ...
  /** \details
    ...
    \param vertexList        [in]  Pointer to an array of vertices.
  */
  OdBool polygonEye(const OdUInt32 numVertices, const OdGePoint3d* vertexList) const;
  ...
  /** \details
    ...
    \param vertexList        [in]  Pointer to an array of vertices.
  */
  OdBool polylineDc(const OdUInt32 numVertices, const OdGePoint3d* vertexList) const;
  ...
  /** \details
    ...
    \param vertexList        [in]  Pointer to an array of vertices.
  */
  OdBool polygonDc(const OdUInt32 numVertices, const OdGePoint3d* vertexList) const;
...
inline void OdGiBaseVectorizer::resetEntityTraitsDataKeepAuxData()
{
  ...
  m_entityTraitsData.setLockFlags(uLockFlags & OdGiDrawableTraits::kInheritableLockFlags);
...
{
  if (m_entityTraitsData.lockFlags() & OdGiDrawableTraits::kKeepAuxDataAndLockFlags)
...
inline void OdGiBaseVectorizer::updateTraitsDataByBlockTraits(const OdGiSubEntityTraitsData* pBlockTraits)
{
  ...
  m_entityTraitsData.setLockFlags(pBlockTraits->lockFlags() & OdGiDrawableTraits::kInheritableLockFlags);
}
#endif
