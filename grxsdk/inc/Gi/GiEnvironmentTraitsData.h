...
inline void OdGiSkyBackgroundTraitsData::skyParameters(OdGiSkyParameters& params) const
{
  ...
  OdCmColor gColor;
  gColor.setColor(m_groundColor.color());
  params.setGroundColor(gColor);

  OdCmColor nColor;
  nColor.setColor(m_nightColor.color());
  params.setNightColor(nColor);
...
inline void OdGiSkyBackgroundTraitsData::setSkyParameters(const OdGiSkyParameters& params)
{
  ...
  m_groundColor = params.groundColor().entityColor();
  m_nightColor = params.nightColor().entityColor();
...
public:
  ...
  */
  OdDbObjectId secondaryBackground() const { return m_secBkgndId; }
  ...
  */
  void setSecondaryBackground(const OdDbObjectId secBkgndId) { m_secBkgndId = secBkgndId; }
