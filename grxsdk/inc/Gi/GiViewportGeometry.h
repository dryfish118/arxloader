...
public:
  ...
  */
  ...
  virtual OdBool rasterImageDc(
    const OdGePoint3d& origin,
    const OdGeVector3d& u,
    const OdGeVector3d& v,
    const OdGeMatrix2d& pixelToDc,
    OdDbObjectId entityId,
    OdGiImageOrg imageOrg,
    OdUInt32 imageWidth,
    OdUInt32 imageHeight,
    OdInt16 imageColorDepth,
    OdBool transparency,
    ImageSource source,
    const OdGeVector3d& unrotatedU,
    const OdGiImageOrg origionalImageOrg,
    const OdGeMatrix2d& unrotatedPixelToDc,
    const OdUInt32 unrotatedImageWidth,
    const OdUInt32 unrotatedImageHeight
  ) const;

  virtual OdBool ownerDrawDc(OdInt32 vpnumber, OdInt32 left, OdInt32 top, OdInt32 right, OdInt32 bottom, const OwnerDraw* pOwnerDraw) const;
  virtual OdBool ownerDraw3d(OdGePoint3d& , OdGePoint3d& , OwnerDraw3d* ) const {  return kFalse; };
};
