...
class ODGI_EXPORT OdGiPaletteOverrideHelper
{
  ...
  public:
    ...
    OdGiPaletteOverrideHelper(OdGiDrawableTraits &pTraits, const OdGiPalette &pOverride) : m_pTraits(NULL)
    { setPaletteOverride(pTraits, pOverride); }
    ~OdGiPaletteOverrideHelper();
    void setPaletteOverride(OdGiDrawableTraits &pTraits, const OdGiPalette &pOverride);
};
