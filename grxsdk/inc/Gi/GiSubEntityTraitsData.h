...
struct OdGiSubEntityTraitsChangedFlags
{
  enum ChangedTraits
  {
    ...
    /** GsMarker has changed. */
    kGsMarkerChanged       = kFirstChangedFlag << 23,
...
public:
  ...
  */
  ...
  /** \details
    ...
    <link gi_shadows_rendering, Shadows Visualization>
  */
  OdResult setShadowFlags(OdGiSubEntityTraits::ShadowFlags shadowFlags);
  ...
  */
  OdResult setSelectionFlags(const OdGiSubEntityTraits::SelectionFlags selectionFlags);
...
inline OdDbStub* OdGiSubEntityTraitsData::layerId() const
{
  return m_layerId;
}
inline OdDbStub* OdGiSubEntityTraitsData::lineTypeId() const
{
  return m_lineTypeId;
}
...
inline OdDb::PlotStyleNameType OdGiSubEntityTraitsData::getPlotStyleNameId(OdDbObjectId &id) const
{
  id = m_plotStyleNameId;
...
inline OdDbStub* OdGiSubEntityTraitsData::materialId() const
{
  return m_materialId;
}
...
inline OdResult OdGiSubEntityTraitsData::setDrawFlags(OdUInt32 drawFlags)
{
...
inline OdResult OdGiSubEntityTraitsData::setShadowFlags(OdGiSubEntityTraits::ShadowFlags shadowFlags)
{
...
inline OdResult OdGiSubEntityTraitsData::setSelectionFlags(const OdGiSubEntityTraits::SelectionFlags selectionFlags)
{
