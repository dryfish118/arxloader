...
class ODGI_EXPORT OdGiTransientManager
{
  public:
    virtual ~OdGiTransientManager()
    {
    ...
    */
    virtual bool addTransient(OdGiDrawable *pDrawable,
                              ...
                              int subMode,
                              const OdIntArray &viewportIds) = 0;
    ...
    */
    ...
    /** \details
        ...
        \param pParent [in]  Parent drawable pointer.
    */
    virtual void updateChildTransient(OdGiDrawable *pDrawable, OdGiDrawable *pParent) = 0;
    ...
    */
    virtual int getFreeSubDrawingMode(OdGiTransientDrawingMode mode,
                                          int &subMode,
                                          const OdIntArray &viewportIds) = 0;
};
...
*/
ODGI_EXPORT OdGiTransientManager *odgiGetTransientManager();
...
/** \details
    ...
    \param pObject [in]  Pointer the object to be cast to the protocol extension.
*/
ODGI_EXPORT void odgiSetTransientManager(OdGiTransientManager* transientManager);
