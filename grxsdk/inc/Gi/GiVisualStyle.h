...
namespace OdGiVisualStyleProperties
{
  ...
  */
  enum Property
  {
    ...
    kPropertyCount                = 58,                      // The number of visual style properties. 
...
class OdGiImpVisualStyle;
class FIRSTDLL_EXPORT OdGiVisualStyle : public OdRxObject
{
public:
  friend class            OdDbVisualStyleImpl;
...
*/
  ...
  virtual bool setTrait(Property prop, const OdCmColor *pColor,
    Operation op = OdGiVisualStyleOperations::kSet);

  virtual bool      setTrait(OdGiVisualStyleProperties::Property prop,
    const OdString *pStr,
    OdGiVisualStyleOperations::Operation op
    = OdGiVisualStyleOperations::kSet);

  virtual const OdGiVariant& trait(Property prop,
  ...
  virtual bool      traitFlag(Property flagProp,
    OdUInt32 flagVal) const;

  static OdGiVariant::VariantType propertyType(Property prop);

 public:
    OdGiVisualStyle(OdGiImpVisualStyle* pImpl);
    
    const OdGiImpVisualStyle* readImp(void) const;
    OdGiImpVisualStyle*       writeImp(void);

private:
    
  OdGiImpVisualStyle* mpOdGiImpVisualStyle;

  mutable OdGiVariant m_props[OdGiVisualStyleProperties::kPropertyCount];
  mutable OdGiVariant m_tmpProp;
};
...
/** \details
    ...
    <link tv_working_with_attributes_visual_styles, Working with Visual Styles>
*/
class FIRSTDLL_EXPORT OdGiImpVisualStyle : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdGiImpVisualStyle);
  ...
  */
  OdGiImpVisualStyle& operator=(const OdGiImpVisualStyle& visualStyle);
  ...
  */
  bool operator==(const OdGiImpVisualStyle& visualStyle) const;
...
*/
typedef OdSmartPtr<OdGiImpVisualStyle> OdGiImpVisualStylePtr;
