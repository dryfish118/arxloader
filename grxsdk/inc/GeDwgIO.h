...
public:
  ...
  static OdResult inFields(OdDbDwgFiler* pFiler, OdGeIntArray& object);
  ...
  static OdResult inFields(OdDbDwgFiler* pFiler, OdGePolyline2d& object);
  ...
  */
  ...
  static OdResult outFields(OdDbDwgFiler* pFiler, const OdGePolyline2d& object);
