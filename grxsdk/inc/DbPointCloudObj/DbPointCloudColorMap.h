...
*/
class DBPOINTCLOUDOBJ_EXPORT OdPointCloudColorSchemeCollectionReactor
{
public: 

  virtual void PointCloudColorSchemeCollectionChanged( class OdDbPointCloudColorMap* colorMap ) = 0;

  /** \details
    Virtual destructor.
  */
  virtual ~OdPointCloudColorSchemeCollectionReactor();
};
...
public:
  ...
  */
  void addColorSchemeCollectionReactor(OdPointCloudColorSchemeCollectionReactor *pReactor );
  ...
  */
  void removeColorSchemeCollectionReactor(OdPointCloudColorSchemeCollectionReactor *pReactor );
  ...
  */
  ...
  NOT IMPLEMENTED
  */
  void getColorSchemeInUse( OdStringArray &GUIDs ) const;

  /** \details
  NOT IMPLEMENTED
  */
  void getClassificationColorSchemeInUse( OdStringArray &GUIDs ) const;
  // DOM-IGNORE-END
