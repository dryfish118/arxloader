...
public:
  ...
  /** \details
    ...
    subcurve: a line segment from (0,0,0) to (1,0,0).
  */
  OdGeCompositeCurve3d();
  OdGeCompositeCurve3d(OdGeCompositeCurve3dImpl* impl);

  /** \details
    Copy constructor for objects of the OdGeCompositeCurve3d class.
  ...
  */
  ...
  /** \details
    Constructor for objects of the OdGeCompositeCurve3d class. Creates a
  ...
  */
  ...
  OdGeCompositeCurve3d(const OdGeVoidPointerArray& curveList,bool isOwnerOfCurves);
  ...
  */
  ...
  /** \details
    ...
    TD Special
  */
  const OdGeVoidPointerArray& getCurveList() const;
  ...
  */
  ...
  /** \details
    ...
    \returns Subcurve parameter value.
  */
  ...
  /** \details
    ...
    parameter on the specifed subcurve.
  ...
  */
  ...
  /** \details
    Assignment operator for objects of the OdGeCompositeCurve3d class. Copies
