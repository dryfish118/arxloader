...
public:
  ...
  */
  ...
  /** \details
    ...
    \param orientation3d  [in]  Array of orientation flags for each 3D curve element (regular or revesed). Valid only if crv3d is not NULL;
    \param orientation2d  [in]  Array of orientation flags for each 2D curve element (regular or revesed). Valid only if crv2d is not NULL;
    \param makeCopy       [in]  If true, makes a copy of 3D and 2D curves (if corresponding arrays are not NULL). 
  */
  OdGeCurveBoundary(
    int numCurves, 
  ...
  /** \details
    ...
    \param source  [in]  Curve boundary to copy.
  */
  ...
  */
  ...
  /** \details
    Assignment operator for the OdGeCurveBoundary class. 
    Assigns properties of the specified cubic spline curve.
    Currently not implemented.

    \param crvBoundary [in] Curve boundary to assign.
  */
  ...
  /** \details
    Checks whether the curve boundary degenerates to a single 3D point.
    Currently not implemented.
  ...
  */
  ...
  /** \details
    ...
    \param crv3d [out] Receives an array of 3D curves for each element in the curve boundary.
    \param crv2d [out] Receives an array of 2D curves for each element in the curve boundary.
    \param orientation3d [out] Receives an array of orientation flags for each 3D curve element. Valid only if crv3d is not NULL; if NULL, the caller must delete allocated memory that was intended for numCurves.
    \param orientation2d [out] Receives an array of orientation flags for each 2D curve element. Valid only if crv2d is not NULL; if NULL, the caller must delete allocated memory that was intended for numCurves.
