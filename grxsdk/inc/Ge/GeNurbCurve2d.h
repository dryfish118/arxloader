...
public:
  ...
  */
  ...
  OdBool buildFitData(OdGe::KnotParameterization kp);

  OdGeNurbCurve2d(const OdGeCurve2d& curve, double epsilon = OdGeContext::gTol.equalPoint());
  /** \details
  ...
  */
  OdBool addControlPointAt(double newKnot, const OdGePoint2d& point, double weight = 1.0);
...
protected:
  ...
  */
  void setData(int degree, const OdGeKnotVector& knots,
    const OdGePoint2dArray& controlPoints, const OdGeDoubleArray& weights, OdBool isPeriodic,
    const OdGePoint2dArray& fitPoints,
    const OdGeVector2d& startTangent,
    const OdGeVector2d& endTangent);
//DOM-IGNORE-END
