...
public:
  ...
  */
  ...
  /** \details
    Calculates the configuration of the intersecion point of the first curve
    with respect to the second, and vice versa.
  ...
  */
  ...
  /** \details
    ...
    \param crvCrvInt [in] Input OdGeCurveCurveInt2d object.
