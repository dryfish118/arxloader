...
struct GE_TOOLKIT_EXPORT OdGeContext
{
  ...
  */
  GE_STATIC_EXPORT static void (*gErrorFunc2)(OdResult);

  GE_STATIC_EXPORT static void (*gErrorFunc)();
...
Corresponding C++ library: TD_Ge
*/
GE_TOOLKIT_EXPORT double getSignedArea(const OdArray<OdGePoint2d> &arrPoints);
