...
public:
  ...
  */
  OdDbObjectIdArray edgeLayers;

  /** \details
    An array of edges linetypes.
  */
  OdDbObjectIdArray edgeLinetypes;

  /** \details
    An array of edges selection markers.
  */
  OdArray<OdLongPtr>    edgeSelectionMarkers;
  ...
  */
  OdArray<OdLongPtr>    faceSelectionMarkers;
  ...
  */
  OdDbObjectIdArray faceMaterials;
  ...
  */
  void draw(OdGiGeometry& geometry)
  {
    ...
    if (!edgeLayers.isEmpty())
      edgeData.setLayers(edgeLayers.getPtr());
    if (!edgeLinetypes.isEmpty()) 
      edgeData.setLineTypes(edgeLinetypes.getPtr());
    ...
    if (!faceLayers.isEmpty()) 
      faceData.setLayers(faceLayers.getPtr());
    ...
    if (!faceMaterials.isEmpty()) 
      faceData.setMaterials(faceMaterials.getPtr());
