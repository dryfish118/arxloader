...
public:
  ...
  */
  ...
  OdGeVector3d (const OdGeVector3d& source) : x(source.x), y(source.y), z(source.z) {}
  ...
  */
  ...
  OdGeMatrix3d rotateTo(const OdGeVector3d& vector, const OdGeVector3d& axis = OdGeVector3d::kIdentity) const;
