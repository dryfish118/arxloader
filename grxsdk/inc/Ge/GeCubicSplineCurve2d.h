...
public:
  ...
  */
  ...
  /** \details
    Copy constructor for the OdGeCubicSplineCurve2d class. Copies the specified cubic spline curve. 
    Currently not implemented.
  ...
  */
  ...
  /** \details
    Constructor for the OdGeCubicSplineCurve2d class. Constructs a periodic (closed)
  ...
  */
  ...
  /** \details
    Constructor for the OdGeCubicSplineCurve2d class. 
    Constructs a cubic spline curve from the input curve that is approximated according to the specified tolerance.
    Currently not implemented.
  ...
  */
  ...
  /** \details
    Constructor for the OdGeCubicSplineCurve2d class. 
    Constructs a cubic spline curve from the passed fit points, knots vector, array of first
    derivatives at the fit points and option that cubic spline curve should be closed.
    Currently not implemented.
  ...
  */
  ...
  /** \details
    Assignment operator for the OdGeCubicSplineCurve2d class. Assigns properties of the specified cubic spline curve.
    Currently not implemented.
