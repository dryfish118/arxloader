...
public:
  ...
  */
  OdGeNurbCurve3d(
    ...
    OdBool startTangentDefined = true,
    OdBool endTangentDefined = true,
  ...
  */  
  ...
  OdBool setFitTangents(const OdGeVector3d& startTangent,
    const OdGeVector3d& endTangent,
    OdBool startTangentDefined,
    OdBool endTangentDefined) const;
  ...
  */
  ...
  OdGeNurbCurve3d& joinWith2(
    const OdGeNurbCurve3d& curve, const OdGeTol &iTolerance = OdGeContext::gTol, const bool bAutoReverse = true);
