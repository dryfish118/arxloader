...
private:
  static
  OdResult writeBoolean(OdGeFiler*, OdBool,
    const OdGeLibVersion&);
  static
  OdResult readBoolean(OdGeFiler*, OdBool*,
    const OdGeLibVersion&);
  OdResult writeBool(OdGeFiler*, bool,
    const OdGeLibVersion&);
  static
    OdResult readBool(OdGeFiler*, bool*,
    const OdGeLibVersion&);
  static
    OdResult writeLong(OdGeFiler*, long,
    const OdGeLibVersion&);
  static
    OdResult readLong(OdGeFiler*, long*,
    const OdGeLibVersion&);
  static
    OdResult writeDouble(OdGeFiler*, double,
    const OdGeLibVersion&);
  static
    OdResult readDouble(OdGeFiler*, double*,
    const OdGeLibVersion&);
  static
    OdResult writePoint2d(OdGeFiler*, const OdGePoint2d&,
    const OdGeLibVersion&);
  static
    OdResult readPoint2d(OdGeFiler*, OdGePoint2d*,
    const OdGeLibVersion&);
  static
    OdResult writeVector2d(OdGeFiler*, const OdGeVector2d&,
    const OdGeLibVersion&);
  static
    OdResult readVector2d(OdGeFiler*, OdGeVector2d*,
    const OdGeLibVersion&);
  static
    OdResult writePoint3d(OdGeFiler*, const OdGePoint3d&,
    const OdGeLibVersion&);
  static    OdResult readPoint3d(OdGeFiler*, OdGePoint3d*,
    const OdGeLibVersion&);
  static
    OdResult writeVector3d(OdGeFiler*, const OdGeVector3d&,
    const OdGeLibVersion&);
  static
    OdResult readVector3d(OdGeFiler*, OdGeVector3d*,
    const OdGeLibVersion&);
  static
    OdResult writeAcGeSurface(OdGeFiler*, const OdGeSurface&,
    const OdGeLibVersion& version);
  static
    OdResult readAcGeSurface(OdGeFiler*, OdGeSurface&,
    const OdGeLibVersion& version);
  static
    OdResult writeAcGeEntity2d(OdGeFiler* pFiler,
    const OdGeEntity2d& ent, const OdGeLibVersion& version);
  static
    OdResult readAcGeEntity2d(OdGeFiler* pFiler, OdGeEntity2d*& ent,
    OdGe::EntityId id, const OdGeLibVersion& version);
  static
    OdResult writeAcGeEntity3d(OdGeFiler* pFiler,
    const OdGeEntity3d& ent, const OdGeLibVersion& version);
  static
    OdResult readAcGeEntity3d(OdGeFiler* pFiler, OdGeEntity3d*& ent,
    OdGe::EntityId id, const OdGeLibVersion& version);
