...
/** \details
  ...
  An OdGeMatrix3d, M, can be expressed as a 4 งท 4 matrix* in the form:
...
public:
  ...
  */
  OdGeMatrix3d()
  {
    ...
    entry[1][0] = entry[1][2] = entry[1][3] =
    entry[2][0] = entry[2][1] = entry[2][3] =
    entry[3][0] = entry[3][1] = entry[3][2] = 0.0;
    entry[0][0] = entry[1][1] = entry[2][2] = entry[3][3] = 1.0;
  }
  OdGeMatrix3d(const OdGeMatrix3d& src)
  {
    OdGeMatrix3d::operator =(src);
  }
  ...
  {    
    ...
    for (row = 0; row < 4; row++)
      for (column = 0; column < 4; column++)
        entry[row][column] = src.entry[row][column];
  ...
  */
  ...
  /** \details
    ...
    \returns This matrix as a product of this matrix and another matrix.
  */
  OdGeMatrix3d& operator *=(
  ...
  */
  ...
  /** \details
    Sets this matrix to its inversion, and returns a reference to this matrix.
  ...
  */
  ...
  /** \details
    Inverts this matrix with the given tolerance.

    \param [in] Tolerance value.
  ...
  */
  ...
  /** \details
    Returns true if and only if this matrix has an inverse, and the inverse of
    this matrix is got.
  ...
  */
  ...
  /** \details
    ...
    \returns True if this matrix is singular; false otherwise.
  ...
  */
  ...
  /** \details
    Returns true if and only if the column vectors of the linear part of this
  ...
  */
  ...
  /** \details
    Returns entry[row] as matrix[row].
  ...
  */
  ...
  /** \details
    References entry[row] as matrix[row].
  ...
  */
  ...
  /** \details
    Returns entry[row][column] as matrix(row,column).
  ...
  */
  ...
  /** \details
    References entry[row][column] as matrix(row,column).
