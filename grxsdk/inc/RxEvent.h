...
#define ODRX_EVENT_OBJ OD_T("AcRxEvent")
...
public:
  ...
  virtual void preXrefLockFile(OdDbDatabase* pDb, OdDbObjectId btrId);
  ...
  // More XREF related Events
    // 
  virtual void xrefSubcommandBindItem(OdDbDatabase* pHost, int activity, OdDbObjectId blockId);
  virtual void xrefSubcommandAttachItem(OdDbDatabase* pHost, int activity, const OdChar* pPath);
  virtual void xrefSubcommandOverlayItem(OdDbDatabase* pHost, int activity, const OdChar* pPath);
  virtual void xrefSubcommandDetachItem(OdDbDatabase* pHost, int activity, OdDbObjectId blockId);
  virtual void xrefSubcommandPathItem(int activity, OdDbObjectId blockId, const OdChar* pNewPath);
  virtual void xrefSubcommandReloadItem(OdDbDatabase* pHost, int activity, OdDbObjectId blockId);
  virtual void xrefSubcommandUnloadItem(OdDbDatabase* pHost, int activity, OdDbObjectId blockId);
  ...
  */
  ...
  virtual void xrefSubCommandEnd(OdDbDatabase* pHostDb,
    OdXrefSubCommand op, const OdArray<OdDbObjectId>& ids,
    const OdChar* const* btrNames,
