...
public:
  ...
  */
  virtual OdResult  createAll(OdArray<OdDbGeoCoordinateSystemCategory*>& allCategories) const = 0;
};
/** \details
...
public:
  ...
  */
  ...
  /** \details
    ...
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  virtual OdResult createAll(const OdGePoint3d& geoPt, OdArray<OdDbGeoCoordinateSystem*>& allCoordSys) const = 0;
  ...
  */
  virtual OdResult createAll(OdArray<OdDbGeoCoordinateSystem*>& allCoordSys, const OdDbGeoCoordinateSystemCategory* pCategory = NULL) const = 0;
};
/** \details
