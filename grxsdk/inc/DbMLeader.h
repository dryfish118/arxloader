...
public:
  ...
  */
  ...
  virtual OdResult dwgOutFields(OdDbDwgFiler* filer) const ODRX_OVERRIDE;

  virtual OdResult dxfInFields (OdDbDxfFiler* filer) ODRX_OVERRIDE;

  virtual OdResult dxfOutFields(OdDbDxfFiler* filer) const ODRX_OVERRIDE;

protected:
  virtual OdBool subWorldDraw(OdGiWorldDraw* pWd) ODRX_OVERRIDE;

  virtual void  subViewportDraw(OdGiViewportDraw* mode) ODRX_OVERRIDE;
  ...
  */
  ...
  virtual OdDbEntity* subSubentPtr(const OdDbFullSubentPath& path) const ODRX_OVERRIDE;
...
public:
  ...
  */
  ...
  OdDbMLeaderStyle::TextAttachmentType  textAttachmentType() const;
