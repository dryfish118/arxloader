...
protected:
  OdDbBackground(OdDbImpBackground* pImp);
  OdDbImpBackground* imp() const;
};
...
public:
  ...
  virtual OdResult setEnable(bool bEnable);
  virtual bool enable() const;
  virtual OdResult setIBLImageName(const OdString &filename);
  virtual OdString IBLImageName() const;
  virtual OdResult setRotation(double rotation);
  virtual double rotation() const;
  virtual OdResult setDisplayImage(bool bDisplay);
  ...
  virtual bool operator==(const OdDbIBLBackground& environment);
