...
public: 
  ...
  */
  explicit OdDbAssocValueDependency(OdDbAssocCreateImpObject createImpObject = kOdDbAssocCreateImpObject);
  ...
  */
  ...
  OdResult getDependentOnObjectValue(OdDbEvalVariant& objectValue) const;
