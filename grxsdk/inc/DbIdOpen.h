...
//inline OdResult 
//oddbOpenObject(OdDbObject *& pObj, OdDbObjectId id, OdDb::OpenMode mode = OdDb::kForRead)
//{
//	return ::oddbOpenOdDbObject(pObj, id, mode, false);
//}
//
//inline OdResult 
//oddbOpenObject(OdDbEntity *& pEnt, OdDbObjectId id, OdDb::OpenMode mode = OdDb::kForRead)
//{
//	return ::oddbOpenOdDbEntity(pEnt, id, mode, false);
//}

inline OdResult 
oddbOpenObject(OdDbObject *& pObj, OdDbObjectId id, OdDb::OpenMode mode = OdDb::kForRead,  bool openErased = false)
{
	return ::oddbOpenOdDbObject(pObj, id, mode, openErased);
}

inline OdResult 
oddbOpenObject(OdDbEntity *& pEnt, OdDbObjectId id, OdDb::OpenMode mode = OdDb::kForRead,  bool openErased = false)
{
	return ::oddbOpenOdDbEntity(pEnt, id, mode, openErased);
}

/*TOOLKIT_EXPORT*/ inline OdResult oddbOpenObject(OdDbObject *& pObj, OdDbObjectId id, OdRxClass * (*pfDesc)(), OdDb::OpenMode mode, bool openErased)
{
  return oddbOpenOdDbObject(pObj, id, mode, (OdRxClass *)pfDesc, openErased);
}
