...
public:
  ...
  /** \details
    ...
    See: <link db_ucs_add_name, Adding and Naming UCSs>
  */
  OdDbUCSTableRecord();
  ...
  /** \details
    ...
    \sa
    <link db_ucs_properties, Specific Properties of UCSs>
  ...
  */
  OdResult setUcsBaseOrigin( const OdGePoint3d& gePoint, OdDb::OrthographicView nView );
