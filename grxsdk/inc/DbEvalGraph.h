...
/** \details
    This class is used by OdDbEvalExpr::remappedNodeIds() to map old node IDs to new node IDs. 
*/
class OdDbEvalIdMap
{
public:
...
public:
  ...
  */
  ...
  // Gcad(Add)
  virtual OdResult getNode(const OdDbEvalNodeId& nodeId, OdDb::OpenMode mode, OdDbObject** ppNode) const;
  ...
  */
  ...
  /** \details
    ...
    The argument graph is emptied as as result of the operation.
    \param pGraphToAdd [in]  Pointer to the Graph object to add.
    \param idMap [out] Pointer to output map from old node ids within 'pGraphToAdd' to their new ids within this graph.
  */
  virtual OdResult addGraph(OdDbEvalGraph* pGraphToAdd, OdDbEvalIdMap*& idMap);
...
public:
  ...
  */
  ...
  /** \details
      OdDbEvalGraph::addGraph() calls this method on each node in the to-be-added graph just after all nodes have been added to the destination graph. 
      The default behavior is to do nothing. Some subclasses of OdDbEvalExpr should override this function to update their references to other nodes. Nodes should not alter the map. 
      This function is called exactly once for each node in a graph after all node IDs in a graph are changed. 
  */
...
/** \details
    ...
    * OdDbEvalGraph
*/
class DYNBLOCKS_EXPORT OdDbEvalContext : public OdRxObject, public OdHeapOperators
{
public:
...
/** \details
    ...
    * OdDbEvalGraph
*/
class DYNBLOCKS_EXPORT OdDbEvalContextPair : public OdHeapOperators
{
public:
...
/** \details
    ...
    * OdDbEvalGraph
*/
class DYNBLOCKS_EXPORT OdDbEvalContextIterator : public OdRxObject, public OdHeapOperators
{
public:
  OdDbEvalContextIterator();
