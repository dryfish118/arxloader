...
/** \details
  ...
  \sa
  <link db_circle_sample, Example of Working with the Circle Object>
  \sa
  <link db_circle, Working with Circles>
  \sa
  <link db_circular_arc, OdDbArc>, <link db_ellipse, OdDbEllipse> classes
*/
...
public:
  ...
  /** \details
    ...
    See: <link db_circle_overview, Overview of Circles>
  */
  OdDbCircle();
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link db_circle_specific, Specific Circle Properties>
	\sa
    <link OdDbCircle::setCenter@OdGePoint3d&, OdDbCircle::setCenter() method>
  */
  ...
  /** \details
    ...
    <link db_circle_specific, Specific Circle Properties>
    \sa
	<link OdDbCircle::center@const, OdDbCircle::center() method>
  */
  ...
  /** \details
    ...
    <link db_circle_specific, Specific Circle Properties>
    \sa
	<link OdDbCircle::setRadius@double, OdDbCircle::setRadius() method>
  */
  double radius() const;
  ...
  /** \details
    ...
    <link db_circle_specific, Specific Circle Properties>
	\sa
    <link OdDbCircle::radius@const, OdDbCircle::radius() method>
  */
  ...
  /** \details
    ...
    <link db_circle_specific, Specific Circle Properties>
	\sa
    <link OdDbCircle::setThickness@double, OdDbCircle::setThickness() method>
  */
  ...
  /** \details
    ...
    <link db_circle_specific, Specific Circle Properties>
	\sa
    <link OdDbCircle::thickness@const, OdDbCircle::thickness() method>
  */
  ...
  /** \details
    ...
    <link db_circle_specific, Specific Circle Properties>
	\sa
    <link OdDbCircle::setNormal@OdGeVector3d&, OdDbCircle::setNormal() method>
  */
  ...
  /** \details
    ...
    <link db_circle_specific, Specific Circle Properties>
	\sa
    <link OdDbCircle::normal@const, OdDbCircle::normal() method>
  */
  ...
  /** \details
    ...
    <link db_circle, Working with Circles>
	\sa
    <link OdDbCircle::getPlane@OdGePlane&@OdDb::Planarity&@const, OdDbCircle::getPlane()>, <link OdDbEntity::isPlanar@const, OdDbEntity::isPlanar()> methods
  */
  ...
  /** \details
    ...
    <link db_circle, Working with Circles>
	\sa
    <link OdDbCircle::isPlanar@const, OdDbCircle::isPlanar()>, <link OdDbEntity::getPlane@OdGePlane&@OdDb::Planarity&@const, OdDbEntity::getPlane()> methods
  */
  ...
  /** \details
    ...
    <link db_circle_sample, Example of Working with the Circle Object>
    \sa
    <link db_circle_compute, Computed Circle Properties>
  */
