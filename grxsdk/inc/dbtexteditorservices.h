...
public:
  ...
  virtual TextEditorStackInternal* setStack() = 0;
...
class TextEditorParagraphInternal
{
public:
  enum AlignmentType
  {
...
class TextEditorColumnInternal
{
public:
...
class TextEditorColumnsInternal
{
public:
  virtual int count() const = 0;
  virtual TextEditorColumnInternal* getAt(int i) const = 0;
};

class TextEditorLocationInternal
{
public:
  virtual void release() = 0;
  virtual GcDbTextEditorLine* curLine() const = 0;
  virtual GcDbTextEditorFragment* curFragment() const = 0;
  virtual TextEditorLocationInternal* next() const = 0;
  virtual bool equal(TextEditorLocationInternal* pOther) const = 0;
};
...
public:
  ...
  virtual TextEditorParagraphInternal* insertParagraph() = 0;

  virtual TextEditorColumnInternal* insertColumn() = 0;

  virtual bool isEditMText() const = 0;
};

class TextEditorSelectionBaseInternal
{
public:
  virtual bool insertString(const OdString& str) = 0;
};

class TextEditorCursorInternal : public TextEditorSelectionBaseInternal
{
public:
...
public:
  ...
  virtual TextEditorLocationInternal* startOfText() = 0;
  virtual TextEditorLocationInternal* endOfText() = 0;
  virtual TextEditorColumnsInternal* textEditorColumns() = 0;
  virtual bool findText(const OdChar* text, int flags,
    TextEditorLocationInternal*& pStart, TextEditorLocationInternal*& pEnd) = 0;
  virtual TextEditorCursorInternal* cursor() = 0;
  virtual bool clearSelection() = 0;
  virtual bool makeSelection(const TextEditorLocationInternal* pStart,
    const TextEditorLocationInternal* pEnd) = 0;
  virtual void redraw() = 0;
  virtual void close() = 0;
};

DBENT_EXPORT void setTextEditorServices(OdDbMText* pMText, GcDbTextEditorServices* pServices);
