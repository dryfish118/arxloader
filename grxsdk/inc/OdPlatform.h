...
#include <WinNls.h>
#include <stringapiset.h>
inline int Od_strcollW(const OdChar* str, const OdChar* str2) { return CompareStringEx(LOCALE_NAME_USER_DEFAULT, 0, (const wchar_t*)str, -1, (const wchar_t*)str2, -1, NULL, NULL, 0) - 2; }
#elif defined(_WIN32) ||defined(_WIN64) || defined(_WIN32_WCE)
inline int Od_strcollW(const OdChar* str, const OdChar* str2) { return CompareStringW(LOCALE_CUSTOM_UI_DEFAULT, 0, (const wchar_t*)str, -1, (const wchar_t*)str2, -1) - 2; }
#elif (defined ( __BORLANDC__ ) && (__BORLANDC__) >= 0x530) ||(defined(_MSC_VER) && _MSC_VER > 1200)
inline int Od_strcollW(const OdChar* str, const OdChar* str2) { return _Wcscoll(str, str2); }
#else
inline int Od_strcollW(const OdChar* str, const OdChar* str2) { return wcscoll(str, str2); }
#endif
#define odStrColl Od_strcollW
#endif
...
#include <WinNls.h>
#include <stringapiset.h>
inline int Od_stricollW(const OdChar* str, const OdChar* str2) { return CompareStringEx(LOCALE_NAME_USER_DEFAULT, NORM_IGNORECASE, (const wchar_t*)str, -1, (const wchar_t*)str2, -1, NULL, NULL, 0) - 2; }
#elif defined(_WIN32) ||defined(_WIN64) || defined(_WIN32_WCE)
inline int Od_stricollW(const OdChar* str, const OdChar* str2) { return CompareStringW(LOCALE_CUSTOM_UI_DEFAULT, NORM_IGNORECASE, (const wchar_t*)str, -1, (const wchar_t*)str2, -1) - 2; }
#elif (defined ( __BORLANDC__ ) && (__BORLANDC__) >= 0x530) ||(defined(_MSC_VER) && _MSC_VER > 1200)
inline int Od_stricollW(const OdChar* str, const OdChar* str2) { return _Wcscoll(str, str2); }
#else
inline int Od_stricollW(const OdChar* str, const OdChar* str2) { return wcscoll(str, str2); }
#endif
#define odStrIColl Od_stricollW
#endif
