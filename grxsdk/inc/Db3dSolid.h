...
public:
  ...
  */
  ...
  /** \details
    ...
    * zLen >= 1e-6
  */
  virtual OdResult createBox(double xLen, double yLen, double zLen);
  ...
  /** \details
    ...
    * topXRadius >= 1e-6
  */
  virtual OdResult createFrustum(double height, double xRadius, double yRadius, double topXRadius);
  ...
  */
  virtual OdResult createTorus(double majorRadius, double minorRadius);
  ...
  /** \details
    ...
    * zLen >= 1e-6
  */
  virtual OdResult createWedge(double xLen, double yLen, double zLen);
  ...
  */
  ...
  OdResult createLoftedSolid(const OdArray<OdDbLoftProfile*>& crossSections,
    const OdArray<OdDbLoftProfile*>& guides,
    OdDbLoftProfile* pPath,
  ...
  */
  ...
  /** \details
    ...
    This method is not implemented.
  */
  OdResult createSculptedSolid(const OdArray<OdDbEntity*>& limitingBodies, const OdGeIntArray& limitingFlags);
  ...
  */
  ...
  virtual OdResult setASMBody(const void* modelerBody);
