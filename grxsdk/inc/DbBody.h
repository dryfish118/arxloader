...
/** \details
  ...
  \remarks
  An OdDbBody entity is a wrapper for an ACIS model and cannot be represented as
  an OdDb3dSolid entity or an OdDbRegion entity.
...
public:
  ...
  */
  ...
  virtual OdResult          setASMBody(const void* modelerBody);  // INTERNAL USE ONLY
  /** \details
  ...
  */
  ...
  /** \details
    ...
    \param filename [in] Name of the file to write ACIS data to.
  ...
  */
  ...
  /** \details
    ...
    \param filename       [in] Name of the file to read ACIS data from.
    \param solids        [out] Receives the array of smart pointers to the ACIS solids.
    \param convAcisColors [in] Flag for conversion ACIS color attributes to their corresponding ODA Platform colors.
    ...
    If pTypeVer is not null, this function returns the version of the ACIS data
    of this 3D solid entity.
    Can convert native ACIS colors to their corresponding ODA Platform colors.

    \sa
   	<exref target="https://docs.opendesign.com/tkernel/ColorConversionType.html>ColorConversionType enum</exref>
  */
  static OdResult acisIn(
    const OdString& filename,
    OdDbEntityPtrArray& solids,
    ColorConversionType convAcisColors = kConvNone);

  static  OdResult acisOut(const OdChar* fileName, const OdDbVoidPtrArray&);
  static  OdResult acisIn(const OdChar* fileName, OdDbVoidPtrArray&);
  /** \details
  ...
  */
  ...
  /** \details
    Returns true if the entity has no view-dependent graphics. In other case
    returns false.
  ...
  */
  ...
  /** \details
    ...
    possibly different viewpoint of the entity. Draws an entity in layout
    viewports.
  ...
  */
  ...
  /** \details
    Determines the behavior for custom objects when saving to a .dwg or .dxf
    file.
    ...
    \returns OdDbObjectPtr for a non-database-resident replacement object or
    NULL. See remarks for details.
    ...
    * Returns NULL, setting replaceId for a database-resident (DBRO) replacement
    ...
    The method is not intended to be called by client code. For processing,
    owned objects use the convertForSave() method.
  */
  ...
  /** \details
    ...
    \returns eOk if new model geometry was successfully set or an appropriate
  ...
  */
  ...
  /** \details
    ...
    The default implementation of this function returns eNotApplicable. This
  ...
  */
  ...
  /** \details
    ...
    \returns Pointer to the resulting copy if successful, NULL otherwise.
  */
  ...
  */
  ...
  /** \details
    Returns the array of OdDbFullSubentPath object(s) by the specified GS
    marker. Each OdDbFullSubentPath object represents a subentity.
  ...
  */
  ...
  TOOLKIT_EXPORT virtual bool usesGraphicsCache();
  ...
  */
  ...
  /** \details
    ...
    ::subSetAttributes(pTraits) with any flags you add. A derived class may not
    remove flags for any reason. The default implementation does nothing but
    return kDrawableNone. This function can be overridden in custom classes.
  */
  virtual OdUInt32 subSetAttributes(OdGiDrawableTraits* pTraits);

  /** \details
    Returns WCS coordinates of box's corner points. The box encloses the 3D
  ...
  */
  ...
  /** \details
    ...
    \param ent     [in] BREP object.
    \param subPath [in] Subentity path.
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdDbBody
  object pointers.
*/
