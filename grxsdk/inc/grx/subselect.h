...
// callbacks from the GcEdInputPointManager. This is a Filter class,
// i.e. needs to be registered with the GcEdInputPointManager
...
// from GcEdSSetSubSelectFilter, and implement the necessary methods
// indicated below.
//
...
public:
    ...
    /**
     * Gets called by the GcEdInputPointManager instance when
     ...
     *
     *
     * @param   flags   GcEdSSGetFlags for the current selection operation
     *
     * @param   pEnt    GcDbEntity that is to be tested.
     *
     ...
     *                  the pick point
     *
     * @param   seltype one of GcDb::kCrossing or GcDb::kWindow.
     * 
     ...
     *                  of the same form as returned by GcEdSSNameEx.
     *
     * @param   bAugment if true, add to current subselection instead of
     *                   replacing it.
     *
     ...
     */
    virtual bool reSubSelectEntity(GcDbEntity* pEnt,
            GcDbFullSubentPathArray& paths)
    { return false; }
    /**
