...
public:
  ...
  const GcArray<Gsoft::GsMarker>&          gsSelectionMark() const;
  const GcArray<GcDbObjectId>&             keyPointEntities() const;
  const GcArray< GcDbObjectIdArray,        GcArrayObjectCopyReallocator< GcDbObjectIdArray > >& 
    nestedKeyPointEntities() const;
  const GcArray<Gsoft::GsMarker>&          keyPointGsSelectionMark() const;
...
public:
  ...
  virtual Gcad::ErrorStatus processInputPoint(
    ...
    const OdArray<Gsoft::GsMarker>&  gsSelectionMark,
    ...
    const OdArray<Gsoft::GsMarker>&  keyPointGsSelectionMark,
...
public:
  ...
  virtual bool excludeFromOsnapCalculation (const OdArray<OdDbObjectId>& nestedEntity,Gsoft::GsMarker gsSelectionMark) { return false; }
};
...
public:
  ...
  virtual void beginNentsel(const GCHAR*    promptString,Gsoft::Boolean pickFlag,int initGetFlags,const GCHAR*    pKeywords) { }
