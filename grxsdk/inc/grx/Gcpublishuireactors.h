...
public:
  ...
  {
    GcPublishUIReactor2::PersistenceRegistryForPubishOptionsDialog(lpszRegRoot);
    return GcPublishUIReactor2::PersistenceRegistryForPubishOptionsDialog(lpszRegRoot, bIsReadRegistry);
  }
