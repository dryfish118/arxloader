...
/////////////////////////////////////////////////////////////////////////////
/// CGdUiCoupledGroupCtrl class dervies from CWnd and provides functionality
...
/// </summary>
///
class GDUI_PORT CGdUiCoupledGroupCtrl : public CWnd {
...
public:
    ...
    /// Destructor.
    /// </summary>
     virtual ~CGdUiCoupledGroupCtrl();

public:
// Overrides
    // ClassWizard generated virtual function overrides
    //{{AFX_VIRTUAL(CGdUiCoupledGroupCtrl)
    //}}AFX_VIRTUAL

// Implementation
public:
    /// <summary>
    /// Given two CGdUiGroupCtrl pointers, hosts them in the coupled group with
    /// a splitter bar in between.
    /// </summary>
    ///
    /// <param name="pGdUiTopWnd">
    /// Input pointer to the CGdUiGroupCtrl which will be hosted in the top 
    /// window of the coupled group.
    /// </param>
    /// <param name="pGdUiBottomWnd">
    /// Input pointer to the CGdUiGroupCtrl which will be hosted in the bottom
    /// window of the coupled group.
    /// </param>
    ///
     virtual void AddCouple(CGdUiGroupCtrl * pIdUiTopWnd, 
                            CGdUiGroupCtrl * pIdUiBottomWnd);
    ...
    /// <summary>
    /// Given a CGdUiGroupCtrl and CWnd pointers, hosts them in the coupled 
    ...
    /// </param>
    ///
     virtual void AddCouple(CGdUiGroupCtrl* pIdUiTopWnd, CWnd* pWndBottom);

    /// <summary>
    /// Given a CWnd and CGdUiGroupCtrl pointers, hosts them in the coupled 
    /// group with a splitter bar in between.
    /// </summary>
    ///
    /// <param name="pWndTop">
    ...
    /// </param>
    ///
     virtual void AddCouple(CWnd* pWndTop, CGdUiGroupCtrl* pIdUiBottomWnd);
...
protected:
    CGdUiGroupCtrl* m_pIdUiTopWnd;
    CGdUiGroupCtrl* m_pIdUiBottomWnd;
    CWnd*           m_pTopWnd;
    CWnd*           m_pBottomWnd;
