...
namespace Gsoft
{
  ...
  const bool kFalse = ::kFalse;
  const bool kTrue =  ::kTrue;
#else
  enum
  {
    kFalse = ::kFalse,
...
typedef Gsoft::Int8        GINT8;
typedef Gsoft::Int16       GINT16;
typedef Gsoft::Int32       GINT32;
typedef Gsoft::Int64       GINT64;

typedef Gsoft::UInt8       GUINT8;
typedef Gsoft::UInt16      GUINT16;
typedef Gsoft::UInt32      GUINT32;
typedef Gsoft::UInt64      GUINT64;

typedef Gsoft::UInt8       GBYTE;
typedef Gsoft::UInt16      GWORD;
typedef Gsoft::UInt32      GDWORD;
typedef Gsoft::UInt64      GQWORD;

typedef Gsoft::size_type   GSIZE;
typedef Gsoft::Boolean     GBOOL;
