...
public:
  ...
  Gcad::ErrorStatus appContextPromptCloseDocument(GcApDocument* pAcTargetDocument);
  ...
  Gcad::ErrorStatus beginExecuteInCommandContext(GcRxExecuteProcPtr procAddr, void *pData);
