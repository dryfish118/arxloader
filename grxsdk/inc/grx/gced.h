...
GCED_DLL_DECL Gsoft::Boolean gcedSetColorDialog (int &nColor, Gsoft::Boolean bAllowMetaColor, int nCurLayerColor);
GCED_DLL_DECL Gsoft::Boolean gcedSetColorDialogTrueColor( GcCmColor& color, Gsoft::Boolean bAllowMetaColor,
...
GCED_DLL_DECL Gsoft::Boolean gcedSetColorDialogTrueColorWithCallback( GcCmColor& color,
...
GCED_DLL_DECL Gsoft::Boolean gcedSetColorPrompt( GCHAR* promptString,
                                   GcCmColor& color,
                                   Gsoft::Boolean bAllowMetaColor);
...
GCAD_DLL_DECL Gsoft::Boolean gcedIsMenuGroupLoaded(const GCHAR *pszGroupName);
...
GCAD_DLL_DECL void gcedReloadMenus(bool bIncrementalReloading);
...
GCAD_DLL_DECL Gsoft::Boolean gcedAddObjectContextMenu(const GcRxClass *pClass, GcEdUIContext *pContext, const void *appId);
GCAD_DLL_DECL Gsoft::Boolean gcedRemoveObjectContextMenu(const GcRxClass *pClass, GcEdUIContext *pContext);

GCAD_DLL_DECL Gsoft::Boolean gcedAddDefaultContextMenu(GcEdUIContext *pContext, const void *appId, const GCHAR* appName=NULL);
GCAD_DLL_DECL Gsoft::Boolean gcedRemoveDefaultContextMenu(GcEdUIContext *pContext);
...
GCED_DLL_DECL Gsoft::UInt8 gcedInitCommandVersion(Gsoft::UInt8 nVersion = 0);
GCED_DLL_DECL Gsoft::UInt8 gcedGetCommandVersion();
GCED_DLL_DECL Gsoft::Boolean gcedInitDialog(Gsoft::Boolean useDialog = Gsoft::kTrue);
...
GCED_DLL_DECL IDispatch* gcadGetIDispatch(BOOL bAddRef);
