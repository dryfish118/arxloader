...
///////////////////////////////////////////////////////////////////////////////
/// CGdUiGroupCtrl class is ownerdrawin group control class that has a header
...
{
    GdUiGroupCtrlData() : nWndIndex(0), title(/*MSG0*/L""), pWnd(NULL), dwBtnCookie((DWORD_PTR)-1) {};
    int nWndIndex;
    CString title;
    CWnd* pWnd;
    DWORD_PTR dwBtnCookie;
} groupData;
typedef std::vector<groupData> GDUIGROUPCTRLDATALIST;
...
{
    GdUiBmpBtnData() : pBmp(NULL), fcnPtr(NULL), 
...
typedef std::vector<bmpBtnData> GDUIHEADERBTNLIST;
...
#define GDUI_GROUP_BUTTONS_RIGHT            25  //was 18
...
#define GDUI_GROUP_BUTTON_DISABLE_FLAG  0x80000000 //Last bit from left
#define GDUI_GROUP_BUTTON_SELECTED_FLAG 0x40000000 //Last second bit from left, flag whether current button is selected.
#define GDUI_GROUP_BUTTON_ID_MASK       0x0000FFFF //Button Id mask. Note that the lower 
...
/// </summary>
///
class GDUI_PORT CGdUiGroupCtrl : public CStatic {
...
public:
    ...
    /// There is a list of GdUiGroupCtrlData that is created with the CWnd,
    ...
    /// typedef void (*GdUiBmpBtnFcnPtr)()
    /// void GdUiBmpBtnFcnPtr() Method
    ...
    ///
    /// <param name="pTheme">
    /// Input parameter to a CGdUiTheme pointer, whose theme colors will be
    ...
    /// the group has GDUI_GROUP_STYLE_NONACTIVE style, there will be
