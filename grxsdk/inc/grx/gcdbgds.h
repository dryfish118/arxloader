...
GCDB_DLL_DECL int gcdbXStrCase (GCHAR *str, size_t strLen);
...
GCDB_DLL_DECL bool gcdbIsExpressionAConstant(const GcString& expression, GcGcDbEvalVariant& val);
GCDB_DLL_DECL bool gcdbIsExpressionANegativeConstant(const GcString& expression);
GCDB_DLL_DECL bool gcdbIsIdentifier(const GcString& name);
