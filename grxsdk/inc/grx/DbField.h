...
#define gcdbGetFieldMarkers               oddbGetFieldMarkers
#define gcdbHasFields                     oddbHasFields
#define gcdbFindField                     oddbFindField
#define gcdbEvaluateFields                oddbEvaluateFields
#define gcdbConvertFieldsToText           oddbConvertFieldsToText
#define gcdbMakeFieldCode                 oddbMakeFieldCode
