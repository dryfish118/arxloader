...
HRESULT GCADAXEXP GcAxGetOwnerId(GcDbObjectId& objId, Gsoft::IntDbId* pOwnerId); 

#ifdef _WIN64
Gsoft::Int32 GCADAXEXP GcAxGetObjectId32(const Gsoft::IntDbId& objId);

Gsoft::IntDbId GCADAXEXP GcAxGetObjectId64(const Gsoft::Int32& objId);
#endif
...
HRESULT GCADAXEXP GcAxGetExtensionDictionary(GcAxObjectRef& objRef, LPDISPATCH pAppDisp, 
                           IGcadDictionary** pExtDictionary);
HRESULT GCADAXEXP GcAxGetOwnerId(GcAxObjectRef& objRef, Gsoft::IntDbId* pOwnerId);
