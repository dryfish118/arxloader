...
GCED_DLL_DECL Gcad::ErrorStatus
gcedXrefNotifyCheckFileChanged(OdDbObjectId btrId, bool& hasChanged);

GCED_DLL_DECL Gcad::ErrorStatus
gcedSkipXrefNotification(OdDbDatabase* pHostDb, const GCHAR* xrefName);

GCED_DLL_DECL Gcad::ErrorStatus
gcedSetXrefResolvedWithUpdateStatus(OdDbBlockTableRecord* pBTR);

GCED_DLL_DECL void gcedMarkForDelayXRefRelativePathResolve(const OdDbObjectId& xrefDefId);

GCED_DLL_DECL void gcedUnmarkForDelayXRefRelativePathResolve(const OdDbObjectId& xrefDefId);
