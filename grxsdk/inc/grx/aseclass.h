...
public:
  ...
  EAsiBoolean setName(const OdChar *pName) ;
  EAsiBoolean getEntity(gds_name EntName) const ;
  EAsiBoolean setEntity(gds_name EntName) ;
...
public:
  ...
  EAsiBoolean initSel(gds_name EntSelName,
    EAseLinkType LinkType=kAseUnknownLinkType) ;
  EAsiBoolean initEnt(gds_name EntName,
    EAseLinkType LinkType=kAseUnknownLinkType) ;
  ...
  EAsiBoolean intersectEnt(gds_name EntName) ;
  EAsiBoolean intersectSel(gds_name EntSelName) ;
  ...
  // which identifier is specified by means of ItemNum position
  // in the link selection
  EAsiBoolean getLinkEnt(long ItemNum, gds_name ename);
  ...
  struct resbuf* getLinkNames() const ;
  EAsiBoolean getEntSel(gds_name EntSelName) const ;
  EAsiBoolean erase() ;
