...
public:
  ...
  virtual Gsoft::UInt32 subSetAttributes(GcGiDrawableTraits* pTraits) { return 0; }

  virtual Gsoft::Boolean subWorldDraw(GcGiWorldDraw* pWordDraw) { return false; }
  ...
  virtual void setGsNode(OdGsCache* pGsNode) { return ;      }
