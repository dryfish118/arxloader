...
class OdDbImpRenderSettings;
class OdDbImpRenderEnvironment;
class OdDbImpRapidRTRenderEnvironment;
class OdDbImpRenderGlobal;
class OdDbImpMentalRayRenderSettings;
...
public:
  ...
  OdDbRenderSettings();
  OdDbRenderSettings(OdDbImpRenderSettings*);
...
public:
  ...
  bool operator==(const OdDbRenderGlobal& global);
