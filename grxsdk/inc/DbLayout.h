...
public:
  ...
  */
  ...
  //yangteng
  void getLimits(OdDbExtents2d& extent) const;

  void getExtents(
    OdGePoint3d& extMin,
    OdGePoint3d& extMax) const;

  void getExtents(OdDbExtents& extent) const;
  ...
  */
  virtual void setLayoutName(ODSYSDEF, const OdString& layoutName);
...
public:
  ...
  */
  ...
  OdResult getGeomExtents(OdDbExtents& extents) const;
