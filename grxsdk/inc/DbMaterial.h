...
/*-------------- New in AC21--------------------*/
  ...
  */
  virtual OdResult setTranslucence(double translucence);
  ...
  */
  virtual OdResult setSelfIllumination(double selfIllumination);
  ...
  */
  virtual OdResult  setReflectivity(double reflectivity);
  ...
  */
  ...
  /** \details
    ...
    \param mode [in]  Mode.
  */
  virtual OdResult setMode(OdGiMaterialTraits::Mode mode);
  ...
  */
  virtual OdResult setChannelFlags(OdGiMaterialTraits::ChannelFlags channelFlags);
  ...
  */
  virtual OdResult setIlluminationModel(OdGiMaterialTraits::IlluminationModel illuminationMode);
  ...
  */
  virtual OdResult normalMap(OdGiMaterialMap &normalMap, OdGiMaterialTraits::NormalMapMethod &method, double &strength) const;
  ...
  */
  ...
  //
  OdResult setAdskMaterialData(const void* pMatObj, bool bCacheIt = false);
  ...
  OdResult  getAdskMaterialFlags(MaterialFlags& flags) const;
  OdResult  setAdskMaterialFlags(MaterialFlags flags);
