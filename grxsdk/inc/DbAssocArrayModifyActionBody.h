...
public:
  ...
  */
  virtual OdResult getItems( OdArray<OdDbAssocArrayItem*>& items ) const;
...
public:
  ...
  */
  explicit OdDbAssocArrayModifyActionBody(OdDbAssocCreateImpObject createImpObject = kOdDbAssocCreateImpObject);
  ...
  */
  ...
  virtual bool controlsItem(const OdDbAssocArrayItem& item) const;
