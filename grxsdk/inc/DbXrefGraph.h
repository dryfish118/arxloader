...
public:
  ...
  */
    ...
    void setXrefNotificationStatus(
      OdDb::XrefNotificationStatus stat) {
      m_statusNotify = stat;
    }

    Oda::OdResult xrefReadSubstatus() const;
    void*   xData();
    void    setxData(void *pXData);
    void setBtrId(const OdDbObjectId& id);
...
public:
  //OdDbXrefGraph() {}
  OdDbXrefGraph(OdDbXrefGraphNode* pHostDwg = NULL);
