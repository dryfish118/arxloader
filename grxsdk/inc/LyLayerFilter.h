...
/** \details
    ...
    <group OdLy_Classes> 
*/
class TOOLKIT_EXPORT OdLyLayerFilter : public OdRxObject, public OdHeapOperators
{
public:
  ...
  */
  ...
  virtual OdResult getImages(HIMAGELIST& imageList, OdUInt32& normalImage, OdUInt32& selected) const;
  ...
  */
  virtual OdResult addNested(OdLyLayerFilter* pLayerFilter);
  ...
  */
  virtual OdResult removeNested(OdLyLayerFilter* pLayerFilter);
  ...
  */
  virtual OdResult setFilterExpression(const OdChar * filterExpression);
  ...
  */
  virtual OdResult writeTo(OdDbDxfFiler* pFiler) const;
...
public:
  ...
  */
  virtual OdResult addLayerId(const OdDbObjectId& layerId);

  /** \details
    Removes the specified layer to this LayerGroup object.
    \param layerId [in]  Object ID of the OdDbLayerTableRecord.
  */
  virtual OdResult removeLayerId(const OdDbObjectId& layerId);
...
public:
  ...
  */
  ...
  virtual OdResult getFilters(OdLyLayerFilter*& pRoot, OdLyLayerFilter*& pCurrent) = 0;
  ...
  */
  virtual OdResult setFilters(const OdLyLayerFilterPtr pRoot, const OdLyLayerFilterPtr pCurrent ) = 0;
  virtual OdResult setFilters(const OdLyLayerFilter* pRoot, const OdLyLayerFilter* pCurrent) = 0;
};
