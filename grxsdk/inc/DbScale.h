...
/** \details
  ...
  \sa
  <link db_scale_sample_object, Example of Working with the Scale Object>

  <link db_scale_sample_dictionary, Example of Working with the Scale Dictionary Object>

  \sa
  <link db_scale, Working with Scales>
...
public:
  ...
  /** \details
    ...
    See: <link db_scale_manipulate, Manipulating Objects of the Scale Dictionary>
  */
  OdDbScale();
  ...
  */
  ...
  virtual OdResult applyPartialUndo(OdDbDwgFiler* pFiler, OdRxClass* pClass) ODRX_OVERRIDE;
};
