...
public:
  ...
  */
  OdResult convertTo(OdDb2dPolyline*&  pPline, OdBool transferId = ::kTrue) const;
  /** \details
  ...
  */
  virtual OdResult setConstantWidth(
  ...
  */
  ...
  /** \details
    ...
    \param vertexIndex [in]  Vertex index.
  */
  virtual OdResult removeVertexAt(unsigned int vertexIndex);
  ...
  */
  virtual OdResult setVertexIdentifierAt(
    unsigned int index,
    OdInt32 suggestedId);
  ...
  */
  bool hasWidth() const;
  OdResult makeClosedIfStartAndEndVertexCoincide(double distTol);
