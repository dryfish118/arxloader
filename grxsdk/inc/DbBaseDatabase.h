...
public:
  ...
  */
  enum ExtentsFlags
  {
    ...
    kUseGivenExtents = 4  //!< Zoom to given extents
  };
  ...
  */
  ...
  /** \details 
    ...
    \param LType    [out] A reference to an OdGiLinetypeDef object to store found linetype information.

    \returns Returns true if the linetype object was found with the specified identifier, otherwise returns false. 
  */
  virtual bool getLineTypeById( OdDbBaseDatabase* db, OdDbStub* pLTypeId, OdGiLinetypeDef& LType ) = 0;
...
public:
  ...
  */
  ...
  /** \details
    ...
    \param obj    [in]  A pointer to a layer object.
    \param LType  [out] An object of the OdGiLinetypeDef class to store and return the information about layer's linetype.
    
    \returns Returns true if the linetype has been successfully retrieved from the layer object, otherwise returns false.
  */
  virtual bool getLineType(OdRxObject* obj, OdGiLinetypeDef& LType) const = 0;
};
