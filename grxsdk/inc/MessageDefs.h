...
OD_MESSAGE_DEF(sidInvalidsetLoftOption1,      OD_T("\n'Closed' option may not be used with 'Normal to' option."))
OD_MESSAGE_DEF(sidInvalidsetLoftOption2,      OD_T("\n'Closed' option may not be used with 'Draft angles' option."))
OD_MESSAGE_DEF(sidInvalidsetLoftOption3,      OD_T("\n'Periodic' option may not be used without 'Closed' option."))
//Point clouds do not display in 2D visual style.
