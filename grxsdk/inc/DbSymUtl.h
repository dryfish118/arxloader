...
namespace OdDbSymUtil
{
  ...
  */
  ...
  inline bool isKindOfBlockPaperSpaceName(const OdString& pN, OdDb::DwgVersion version = OdDb::kDHL_CURRENT)
  {
    OdString strPaperSpaceName = OdDbSymUtil::blockPaperSpaceName(version);
    return odStrICmp(pN.left(strPaperSpaceName.getLength()), strPaperSpaceName) == 0;
  }
