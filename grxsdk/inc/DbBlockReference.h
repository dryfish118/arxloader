...
/** \details
  ...
  OdDbAttribute object pointers.
*/
typedef OdSmartPtr<OdDbAttribute> OdDbAttributePtr;

/** \details
  This template class is a specialization of the OdSmartPtr class for
  OdDbSequenceEnd object pointers.
*/
...
public:
  ...
  /** \details
    This is the default constructor for objects of the OdDbBlockReference
    class.
  */
  OdDbBlockReference();
  ...
  /** \details
    Returns the Object ID of the block table record associated with this
    OdDbBlockReference (DXF 2).
  */
  OdDbObjectId blockTableRecord() const;

  /** \details
    Sets the Object ID of the block table record associated with this
    OdDbBlockReference (DXF 2).
  ...
  */
  ...
  /** \details
    ...
    \remarks
    Rotation is about the Z axis, relative the X-axis, in the coordinate system
  ...
  */
  ...
  /** \details
    Sets the rotation angle to be applied to this block reference, in radians
    (DXF 50).

    \remarks
    Rotation is about the Z axis, relative the X-axis, in the coordinate system
    parallel to this object's OCS, but with its origin at this object's insertion
    point.
  ...
  */
  ...
  /** \details
    Appends the specified OdDbAttribute to the attribute list of this block
    reference.
    ...
    \remarks
    This block reference becomes the owner of the passed in attribute, and the
    attribute is added to the database to which this block reference belongs.
  ...
  */
  OdDbObjectId appendAttribute(ODSYSDEF,
    OdDbAttribute* pAttr);
  ...
  */
  ...
  /** \details
    Explodes this entity into a set of simpler entities, and adds them to the
    ...
    The newly created entities are database resident or not depending on the
    block table record they are appended to. If block table record is database
    resident the entities are database resident as well. If block table record
    is not database resident newly created entities are not database resident.
  ...
  */
  ...
  /** \details
    ...
    3) If it returns eOK, continue; otherwise return whatever the parent's
       dxfOutFields_R12(pFiler) returned.
    4) Call the OdDbDxfFiler(pFiler) methods to read each of the object's data
       items in the order they were written.
    5) Return pFiler->filerStatus().
 */
  ...
  */
  ...
  /** \details
    ...
    \remarks
    This function calls this object's dxfOutFields(pFiler) function, writes any
    Xdata associated with this object.
  */
  ...
  */ 
  ...
  /** \details
    ...
    \param pNewObject [in] Pointer to the object with which to replace this
  ...
  */
  ...
  /** \details
    ...
    entities from geometry generated by subWorldDraw().
    This function can be overridden in custom classes.
  */
  ...
  */
  ...
  /** \details
    This method gets copies of all entities in the referenced block table
    record, applies parentXform to them and after this calculates extents on the
  ...
  */
  ...
  /** \details
    Explodes the current object and appends resulting entities to the block
    table record which owns the current OdDbBlockReference object that calls
    this method.
  ...
  */
  ...
  /** \details
    ...
    \remarks
    The default implementation of this function does nothing but throw an
  ...
  */  
  virtual OdResult copyFrom(const OdRxObject* pSrc) ODRX_OVERRIDE;
...
/** \details
  This template class is a specialization of the OdSmartPtr class for
  OdDbBlockReference object pointers.
*/
