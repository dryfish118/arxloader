...
/** \details
  ...
  \sa
  <link db_line_sample, Example of Working with the Line Object>

  \sa
  <link db_line, Working with Lines>
...
public:
  ...
  /** \details
    ...
    See: <link db_line_overview, Overview of Lines>
  */
  OdDbLine();
  ...
  /** \details
    ...
    \sa
    <link db_line_specific, Specific Line Properties>
  ...
  */
  OdResult setStartPoint( const OdGePoint3d& geStartPoint );
  ...
  */
  OdResult setEndPoint( const OdGePoint3d& geEndPoint );
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link db_line_compute, Computed Line Properties>
  */
